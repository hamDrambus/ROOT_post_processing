...
public:
	enum Type {
		...
		MPPC_coord, MPPC_coord_x, MPPC_coord_y, MPPC_Npe_sum, MPPC_N_sum, MPPC_S2,
		MPPC_trigger_fit, MPPC_trigger_fit_chi2,
		...
		PMT_trigger_fit_chi2, PMT_trigger_bNpe, PMT_trigger_bNpeaks, PMT_trigger_bS};
protected:
