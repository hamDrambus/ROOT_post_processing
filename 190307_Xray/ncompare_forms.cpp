...
int ncompare_forms (void) {
	...
	double time_pretrigger_left = 1, time_pretrigger_right = 20;
	double time_left = 0, time_right = 160;//us
	double max_val = 0;
	double trigger_at = center_at_S1 ? 40 : 66;
	double y_min = 1e-5;
	double y_max = 4e-1;
...
define->folder = "190307_Xray/results_v1/Xray_46V_20kV_650V/";
define->folder += "forms_X-ray/";
define->fnames.push_back(edge_SiPMs ? "SiPMs_edge_form_by_Npe.hdata" : "SiPMs_form_by_Npe.hdata");
define->Td = "8.5";
define->device = edge_SiPMs ? "SiPM-matrix (edge)" : "SiPM-matrix";
define->fast_t_center = 61;
define->fast_t = PAIR(49, 80);
define->S1_t_center = 32.7;
define->S1_t = PAIR(32.0, 33.2);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(87, 159);
define->long_fit_t = PAIR(87, 159);
define->baseline_bound = PAIR(1e-7, 2e-5);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 25);
define->long_ampl_bound = PAIR(3e-4, 1e-1);
define->long_tau_bound = PAIR(30, 300);
...
define->folder = "190307_Xray/results_v1/Xray_46V_18kV_650V/";
define->folder += "forms_X-ray/";
define->fnames.push_back(edge_SiPMs ? "SiPMs_edge_form_by_Npe.hdata" : "SiPMs_form_by_Npe.hdata");
define->Td = "7.6";
define->device = edge_SiPMs ? "SiPM-matrix (edge)" : "SiPM-matrix";
define->fast_t_center = 62.3;
define->fast_t = PAIR(49, 82);
define->S1_t_center = 32.7;
define->S1_t = PAIR(32.0, 33.2);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->folder = "190307_Xray/results_v1/Xray_46V_16kV_650V/";
define->folder += "forms_X-ray/";
define->fnames.push_back(edge_SiPMs ? "SiPMs_edge_form_by_Npe.hdata" : "SiPMs_form_by_Npe.hdata");
define->Td = "6.8";
define->device = edge_SiPMs ? "SiPM-matrix (edge)" : "SiPM-matrix";
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(90, 159);
define->long_fit_t = PAIR(90, 159);
define->baseline_bound = PAIR(1e-7, 2e-5);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 25);
define->long_ampl_bound = PAIR(3e-4, 1e-1);
...
define->folder = "190307_Xray/results_v1/Xray_46V_14kV_650V/";
define->folder += "forms_X-ray/";
define->fnames.push_back(edge_SiPMs ? "SiPMs_edge_form_by_Npe.hdata" : "SiPMs_form_by_Npe.hdata");
define->Td = "5.9";
define->device = edge_SiPMs ? "SiPM-matrix (edge)" : "SiPM-matrix";
define->fast_t_center = 66.3;
define->fast_t = PAIR(47, 86);
define->S1_t_center = 32.7;
define->S1_t = PAIR(32.0, 33.2);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(92, 159); //!!!92->91 affects long compoenent tau dramatically (100->44)
define->long_fit_t = PAIR(92, 159);
define->baseline_bound = PAIR(1e-7, 2e-5);
define->slow_ampl_bound = PAIR(1e-4, 1e-1);
define->slow_tau_bound = PAIR(2.5, 25);
define->long_ampl_bound = PAIR(1e-5, 1e-2);
define->long_tau_bound = PAIR(30, 300);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
define->folder = "190307_Xray/results_v1/Xray_46V_12kV_650V/";
define->folder += "forms_X-ray/";
define->fnames.push_back(edge_SiPMs ? "SiPMs_edge_form_by_Npe.hdata" : "SiPMs_form_by_Npe.hdata");
define->Td = "5.1";
define->device = edge_SiPMs ? "SiPM-matrix (edge)" : "SiPM-matrix";
define->fast_t_center = 68.9;
define->fast_t = PAIR(45, 87);
define->S1_t_center = 32.7;
define->S1_t = PAIR(32.0, 33.2);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(96, 159);
define->long_fit_t = PAIR(96, 159);
define->baseline_bound = PAIR(1e-7, 2e-5);
define->slow_ampl_bound = PAIR(1e-4, 1);
define->slow_tau_bound = PAIR(2.5, 25);
define->long_ampl_bound = PAIR(1e-5, 1e-2);
define->long_tau_bound = PAIR(30, 300);
define->simultaneous_fit = true;
...
define->folder = "190307_Xray/results_v1/Xray_46V_10kV_650V/";
define->folder += "forms_X-ray/";
define->fnames.push_back(edge_SiPMs ? "SiPMs_edge_form_by_Npe.hdata" : "SiPMs_form_by_Npe.hdata");
define->Td = "4.2";
define->device = edge_SiPMs ? "SiPM-matrix (edge)" : "SiPM-matrix";
define->fast_t_center = 68.9;
define->fast_t = PAIR(40, 87);
define->S1_t_center = 32.7;
define->S1_t = PAIR(32.0, 33.2);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(91, 159);
define->long_fit_t = PAIR(91, 159);
define->baseline_bound = PAIR(1e-7, 1e-5);
define->slow_ampl_bound = PAIR(1e-4, 1);
define->slow_tau_bound = PAIR(2.5, 9);
define->long_ampl_bound = PAIR(1e-5, 1e-2);
define->long_tau_bound = PAIR(10, 300);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
define->folder = "190307_Xray/results_v1/Xray_46V_20kV_650V/";
define->folder += "forms_X-ray/";
define->fnames = {"1_form_by_S.hdata"};
define->Td = "8.5";
define->device = "3PMT (slow)";
define->fast_t_center = 60.6;
define->fast_t = PAIR(40, 82);
...
define->long_fit_t = PAIR(85, 159);
define->baseline_bound = PAIR(1e-7, 2e-6);
define->slow_ampl_bound = PAIR(1e-5, 1e-2);
define->slow_tau_bound = PAIR(2, 15);
define->long_ampl_bound = PAIR(1e-6, 1e-3);
...
define->fit_option = def_fit_option;
	...
	std::string folder = PMTs ? std::string("190307_Xray/results_v1/PMTs/")
					: std::string("190307_Xray/results_v1/SiPMs/");
#ifdef FAST_FIGURES_MODE
	...
	if (PMTs)
		framename = std::string("Results for 4PMT (no WLS), ")+"X-ray Mo tube";// + " " + Tds[0] + " Td";
	else
		framename = std::string("Results for SiPM-matrix (no WLS), ")+"X-ray Mo tube";// + " " + Tds[0] + " Td";
  ...
  max_val*= linear ? 1.2 : 2;
	...
	TH2F* frame = new TH2F("frame", framename.c_str(), 500, time_left, time_right, 500, linear ? 0 : y_min, (y_max == DBL_MAX ? max_val : y_max));
	...
	if (!linear) {
		...
		if (print_errors) {
			...
			add_text(85, 0.005, no_title, tau1, palette_major);
			add_text(111, 0.005, Slow_title, frsS, palette_major);
			add_text(123, 0.005, Long_title, frsL, palette_major);
			add_text(138, 0.005, no_title, tau2, palette_major);
		}
	} else {
		std::vector<std::string> no_title;
