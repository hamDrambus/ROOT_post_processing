...
//Similar to 210923/5analysis_history.cpp
...
S2_times["210930_Pu_20.0kV_800V_46V_12dB_2650V"] = std::pair<double, double> (22, 30.5);
S2_times["210930_Pu_20.0kV_800V_46V_12dB_2650V_1"] = std::pair<double, double> (22, 30.5);
S2_times["210930_Pu_18.8kV_800V_46V_12dB_2650V"] = std::pair<double, double> (22, 30.5);

std::map<std::string, std::string> exp_folders;
exp_folders["210930_Pu_20.0kV_800V_46V_12dB_2650V"] = "Pu_46V_20.0kV_800V_2650V";
exp_folders["210930_Pu_20.0kV_800V_46V_12dB_2650V_1"] = "Pu_46V_20.0kV_800V_2650V_1";
exp_folders["210930_Pu_18.8kV_800V_46V_12dB_2650V"] = "Pu_46V_18.8kV_800V_2650V";

std::map<std::string, double> pre_trigger_max_S; //for calibration only
pre_trigger_max_S["210930_Pu_20.0kV_800V_46V_12dB_2650V"] = 0.71;
pre_trigger_max_S["210930_Pu_20.0kV_800V_46V_12dB_2650V_1"] = 0.71;
pre_trigger_max_S["210930_Pu_18.8kV_800V_46V_12dB_2650V"] = 0.67;
...
//zcxv
if (exp == "210930_Pu_20.0kV_800V_46V_12dB_2650V" || exp == "210930_Pu_20.0kV_800V_46V_12dB_2650V_1") {
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_bins(500);
	x_y_regions = {1510, 0, 3710, 884, 6999, 3086};
...
if (exp == "210930_Pu_18.8kV_800V_46V_12dB_2650V") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 7000, 0, 7000);
	set_bins(500);
	x_y_regions = {1343, 0, 3693, 941, 6999, 3086};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_0-160us");
