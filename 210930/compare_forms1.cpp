...
//For 210930/results_v5
//10.0 mm with 238Pu set on the cathode. (Mesh instead of THGEM0, 28% CERN #8 as THEGEM1, PMT#1 malfunctions due to mixed signal wires)
...
enum ShapeFileType {Histogram = 0, Raw = 1, RawIntegral = 2};
...
int compare_forms1 (void) {
	...
	double time_pretrigger_left = 2.0, time_pretrigger_right = 17.0;
...
define->folder = std::string("210930/results_v5/Pu_46V_20.0kV_800V_2650V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
...
define->fit_option = def_fit_option;
	...
	pulse_shape SiPM_20_0kV_no_trigger_v2;
	define = &SiPM_20_0kV_no_trigger_v2;
	copy = &SiPM_20_0kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(33.0, 53);
define->long_fit_t = PAIR(93, 152);
...
define->folder = std::string("../Data/210930/results_v2/210930_Pu_20.0kV_800V_46V_12dB_2650V/Charge_10/");
define->fnames.push_back("Charge210930_Pu_20.0kV_800V_46V_12dB_2650V_ch_10_AVR_0");
define->file_type = ShapeFileType::Raw;
define->Td = "~8.2";
define->device = "Charge";
define->fast_t_center = 30.4;
define->fast_t = PAIR(29.0, 31.2);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtract_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(32, 37);
...
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = "NRE";

  pulse_shape Q_20_0kV_no_trigger_1;
  define = &Q_20_0kV_no_trigger_1;
define->folder = std::string("../Data/210930/results_v2/210930_Pu_20.0kV_800V_46V_12dB_2650V_1/Charge_10/");
define->fnames.push_back("Charge210930_Pu_20.0kV_800V_46V_12dB_2650V_1_ch_10_AVR_0");
define->file_type = ShapeFileType::RawIntegral;
define->Td = "~8.2";
define->device = "Charge";
define->fast_t_center = 65.6;
define->fast_t = PAIR(54, 73.7);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtract_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(75.7, 100);
define->long_fit_t = PAIR(0, 0);
define->baseline_bound = PAIR(1e-6, 1e-6);
...
define->fit_option = "NRE";
	...
	std::vector<pulse_shape> pulses = {SiPM_20_0kV_no_trigger_v2};
  ...
  max_val*= linear ? 1.2 : 2;
    ...
    if (ShapeFileType::Histogram == pulses[hh].file_type) {
      ...
      pulses[hh].graph->SetLineWidth(1);
