...
{
	gSystem->SetIncludePath("-I$ROOTSYS/include -I$HOME/Documents/Post_processing/include -I$HOME/Documents/Post_processing/source -I$HOME/Documents/Post_processing/build");
	gSystem->AddDynamicPath("$HOME/Documents/Post_processing/build");
