...
define->folder = "170622/results_v5/Cd_46V_18kV_700V_th190mV/iteration_00/";
define->folder += Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/";
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "7.6";
define->device = "SiPM-matrix";
define->fast_t_center = 30;
define->fast_t = PAIR(28, 35.1);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->folder = "170622/results_v5/Cd_46V_16kV_700V/iteration_00/";
define->folder += Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/";
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "6.8";
define->device = "SiPM-matrix";
...
define->folder = "170622/results_v5/Cd_46V_14kV_700V/iteration_00/";
define->folder += Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/";
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "5.9";
define->device = "SiPM-matrix";
define->fast_t_center = 30;
define->fast_t = PAIR(28, 36);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(36, 160);
define->long_fit_t = PAIR(36, 160);
define->baseline_bound = PAIR(1e-6, 3e-4);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2, 10);
define->long_ampl_bound = PAIR(3e-4, 1e-1);
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(35.6, 51);
define->long_fit_t = PAIR(60, 120);
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(36.3, 49);
define->long_fit_t = PAIR(55, 115);
define->baseline_bound = PAIR(1e-6, 1e-2);
define->long_baseline_bound = PAIR(1e-6, 2e-4);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2, 10);
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(35.7, 49);
define->long_fit_t = PAIR(51, 115);
define->baseline_bound = PAIR(1e-6, 1e-2);
define->long_baseline_bound = PAIR(1e-6, 2e-4);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2, 10);
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(36.5, 46);
define->long_fit_t = PAIR(55, 100);
define->baseline_bound = PAIR(1e-6, 1e-2);
define->long_baseline_bound = PAIR(1e-6, 2e-4);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2, 10);
...
copy = &SiPM_20kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_20kV_700V/iteration_00/";
define->folder += "forms_Cd_peak_no_cuts/";
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "8.5";
define->device = "SiPM-matrix (no cuts)";
define->fast_t_center = copy->fast_t_center;
define->fast_t = copy->fast_t;
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
...
pulse_shape SiPM_18kV_no_cuts;
define = &SiPM_18kV_no_cuts;
copy = &SiPM_18kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_18kV_700V_th300mV/iteration_00/";
define->folder += "forms_Cd_peak_no_cuts/";
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "7.6";
define->device = "SiPM-matrix (no cuts)";
...
pulse_shape SiPM_16kV_no_cuts;
define = &SiPM_16kV_no_cuts;
copy = &SiPM_16kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_16kV_700V/iteration_00/";
define->folder += "forms_Cd_peak_no_cuts/";
define->fnames = {"SiPMs_form_by_Npe.hdata"};
...
pulse_shape SiPM_14kV_no_cuts;
define = &SiPM_14kV_no_cuts;
copy = &SiPM_14kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_14kV_700V/iteration_00/";
define->folder += "forms_Cd_peak_no_cuts/";
define->fnames = {"SiPMs_form_by_Npe.hdata"};
...
define->fit_option = def_fit_option;
	...
	pulse_shape PMT3_20kV_no_trigger;
	define = &PMT3_20kV_no_trigger;
	copy = &SiPM_20kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_20kV_700V/iteration_00/";
define->folder += Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/";
define->fnames = {"0_form_by_Npe.hdata"};
define->Td = "8.5";
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(37.5, 160);
define->long_fit_t = PAIR(37.5, 160);
...
pulse_shape PMT3_18kV_no_trigger;
define = &PMT3_18kV_no_trigger;
copy = &SiPM_18kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_18kV_700V_th190mV/iteration_00/";
define->folder += Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/";
define->fnames = {"0_form_by_Npe.hdata"};
...
pulse_shape PMT3_16kV_no_trigger;
define = &PMT3_16kV_no_trigger;
copy = &SiPM_16kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_16kV_700V/iteration_00/";
define->folder += Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/";
define->fnames = {"0_form_by_Npe.hdata"};
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(36.2, 160);
define->long_fit_t = PAIR(36.2, 160);
...
pulse_shape PMT3_14kV_no_trigger;
define = &PMT3_14kV_no_trigger;
copy = &SiPM_14kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_14kV_700V/iteration_00/";
define->folder += Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/";
define->fnames = {"0_form_by_Npe.hdata"};
...
define->device = "3PMT+WLS";
define->fast_t_center = 30;
define->fast_t = PAIR(26, 35.8);
define->S1_t_center = copy->S1_t_center;
define->S1_t = copy->S1_t;
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(36.4, 160);
define->long_fit_t = PAIR(36.4, 160);
define->baseline_bound = PAIR(1e-5, 1e-3);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2, 10);
define->long_ampl_bound = PAIR(3e-4, 1e-1);
...
pulse_shape PMT3_20kV_no_cuts;
define = &PMT3_20kV_no_cuts;
copy = &PMT3_20kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_20kV_700V/iteration_00/";
define->folder += "forms_Cd_peak_no_cuts/";
define->fnames = {"0_form_by_Npe.hdata"};
define->Td = "8.5";
define->device = "3PMT+WLS (no cuts)";
define->fast_t_center = 30;
define->fast_t = PAIR(28, 35.5);
define->S1_t_center = copy->S1_t_center;
define->S1_t = copy->S1_t;
...
pulse_shape PMT3_18kV_no_cuts;
define = &PMT3_18kV_no_cuts;
copy = &PMT3_18kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_18kV_700V_th190mV/iteration_00/";
define->folder += "forms_Cd_peak_no_cuts/";
define->fnames = {"0_form_by_Npe.hdata"};
define->Td = "7.6";
...
pulse_shape PMT3_16kV_no_cuts;
define = &PMT3_16kV_no_cuts;
copy = &PMT3_16kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_16kV_700V/iteration_00/";
define->folder += "forms_Cd_peak_no_cuts/";
define->fnames = {"0_form_by_Npe.hdata"};
define->Td = "6.8";
...
pulse_shape PMT3_14kV_no_cuts;
define = &PMT3_14kV_no_cuts;
copy = &PMT3_14kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_14kV_700V/iteration_00/";
define->folder += "forms_Cd_peak_no_cuts/";
define->fnames = {"0_form_by_Npe.hdata"};
define->Td = "5.9";
...
pulse_shape PMT3_20kV_no_cuts_bN;
define = &PMT3_20kV_no_cuts_bN;
copy = &PMT3_20kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_20kV_700V/iteration_00/";
define->folder += "forms_Cd_peak_no_cuts/";
define->fnames = {"0_form_by_Npeaks.hdata"};
define->Td = "8.5";
define->device = "3PMT+WLS (no cuts, N peaks)";
define->fast_t_center = 30;
define->fast_t = PAIR(25, 40);
define->S1_t_center = copy->S1_t_center;
define->S1_t = copy->S1_t;
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(42, 160);
define->long_fit_t = PAIR(42, 160);
define->baseline_bound = PAIR(1e-5, 5e-4);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2, 10);
define->long_ampl_bound = PAIR(3e-4, 1e-1);
...
pulse_shape PMT3_18kV_no_cuts_bN;
define = &PMT3_18kV_no_cuts_bN;
copy = &PMT3_18kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_18kV_700V_th190mV/iteration_00/";
define->folder += "forms_Cd_peak_no_cuts/";
define->fnames = {"0_form_by_Npeaks.hdata"};
...
define->device = "3PMT+WLS (no cuts, N peaks)";
define->fast_t_center = 30;
define->fast_t = PAIR(25, 39.7);
define->S1_t_center = copy->S1_t_center;
define->S1_t = copy->S1_t;
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(40.8, 160);
define->long_fit_t = PAIR(40.8, 160);
define->baseline_bound = PAIR(1e-5, 5e-4);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2, 10);
define->long_ampl_bound = PAIR(3e-4, 1e-1);
define->long_tau_bound = PAIR(100, 300);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;

pulse_shape PMT3_16kV_no_cuts_bN;
define = &PMT3_16kV_no_cuts_bN;
copy = &PMT3_16kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_16kV_700V/iteration_00/";
define->folder += "forms_Cd_peak_no_cuts/";
define->fnames = {"0_form_by_Npeaks.hdata"};
...
define->device = "3PMT+WLS (no cuts, N peaks)";
define->fast_t_center = 30;
define->fast_t = PAIR(25, 37.2);
define->S1_t_center = copy->S1_t_center;
define->S1_t = copy->S1_t;
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(38.3, 160);
define->long_fit_t = PAIR(38.3, 160);
define->baseline_bound = PAIR(1e-5, 5e-4);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2, 10);
define->long_ampl_bound = PAIR(3e-4, 5e-1);
define->long_tau_bound = PAIR(20, 300);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;

pulse_shape PMT3_14kV_no_cuts_bN;
define = &PMT3_14kV_no_cuts_bN;
copy = &PMT3_14kV_no_trigger;
define->folder = "170622/results_v5/Cd_46V_14kV_700V/iteration_00/";
define->folder += "forms_Cd_peak_no_cuts/";
define->fnames = {"0_form_by_Npeaks.hdata"};
...
define->fit_option = def_fit_option;
	...
	std::string folder = PMTs ? std::string("170622/results_v5/PMTs_i00/")
					: std::string("170622/results_v5/SiPMs_i00/");
#ifdef FAST_FIGURES_MODE
	std::vector<pulse_shape> pulses;
	if (PMTs) {
		if (in_kV == "20")
			pulses.push_back((combined ? PMT3_20kV_no_trigger :  PMT3_20kV_no_trigger_v2));
		if (in_kV == "18")
			pulses.push_back((combined ? PMT3_18kV_no_trigger :  PMT3_18kV_no_trigger_v2));
		if (in_kV == "16")
			pulses.push_back((combined ? PMT3_16kV_no_trigger :  PMT3_16kV_no_trigger_v2));
		if (in_kV == "14")
			pulses.push_back((combined ? PMT3_14kV_no_trigger :  PMT3_14kV_no_trigger_v2));
	} else {
		if (in_kV == "20")
...
#else //FAST_FIGURES_MODE
	//std::vector<pulse_shape> pulses = {SiPM_14kV_no_trigger_v2};
	...
	//std::vector<pulse_shape> pulses = {SiPM_20kV_no_trigger_v2, SiPM_18kV_no_trigger_v2, SiPM_16kV_no_trigger_v2, SiPM_14kV_no_trigger_v2};
	//std::vector<pulse_shape> pulses = {SiPM_20kV_no_cuts, SiPM_18kV_no_cuts, SiPM_16kV_no_cuts, SiPM_14kV_no_cuts};
	//std::vector<pulse_shape> pulses = {PMT3_20kV_no_trigger, PMT3_18kV_no_trigger, PMT3_16kV_no_trigger, PMT3_14kV_no_trigger};
	std::vector<pulse_shape> pulses = {PMT3_20kV_no_cuts, PMT3_18kV_no_cuts, PMT3_16kV_no_cuts, PMT3_14kV_no_cuts};
	//std::vector<pulse_shape> pulses = {PMT3_20kV_no_cuts_bN, PMT3_18kV_no_cuts_bN, PMT3_16kV_no_cuts_bN, PMT3_14kV_no_cuts_bN};
	...
	if (PMTs)
		framename = std::string("Results for 3PMT+WLS, ")+(Cd_peak ? "" : "< ")+"82 keV #gamma ^{109}Cd";// + " " + Tds[0] + " Td";
	else
	...
	if (!linear) {
		...
		if (print_errors) {
			...
			add_text(67-16, 0.017, no_title, tau1, palette_major);
			add_text(75, 0.017, Slow_title, frsS, palette_major);
			add_text(89, 0.017, Long_title, frsL, palette_major);
			add_text(109, 0.017, no_title, tau2, palette_major);
		}
	} else {
		std::vector<std::string> no_title;
		std::vector<std::string> Slow_title = {"Slow component", "contribution:"};
