...
int compare_forms (void) {
	...
	pulse_shape SiPM_785V_no_trigger;
	define = &SiPM_785V_no_trigger;
define->folder = "221124/results_v1/X-ray_20kV_785V/forms_X-ray/";
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "85";
define->device = "SiPM matrix";
define->fast_t_center = 32.7;
define->fast_t = PAIR(31, 40);
...
define->fit_option = def_fit_option;
	...
	pulse_shape SiPM_739V_no_trigger;
	define = &SiPM_739V_no_trigger;
	copy = &SiPM_785V_no_trigger;
*define = *copy;
define->folder = "221124/results_v1/X-ray_20kV_739V/forms_X-ray/";
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "80";
define->scale = 1;

pulse_shape SiPM_369V_no_trigger;
define = &SiPM_369V_no_trigger;
copy = &SiPM_785V_no_trigger;
*define = *copy;
define->folder = "221124/results_v1/X-ray_20kV_369V/forms_X-ray/";
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "40";
define->scale = 1;

pulse_shape SiPM_462V_no_trigger;
define = &SiPM_462V_no_trigger;
copy = &SiPM_785V_no_trigger;
*define = *copy;
define->folder = "221124/results_v1/X-ray_20kV_462V/forms_X-ray/";
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "50";
define->scale = 1;

	pulse_shape SiPM_000V_no_trigger;
	define = &SiPM_000V_no_trigger;
	copy = &SiPM_785V_no_trigger;
*define = *copy;
define->folder = "221124/results_v1/X-ray_20kV_000V/forms_X-ray/";
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "0";
define->scale = 1;

	//for paper:
	std::vector<pulse_shape> pulses = {SiPM_785V_no_trigger, SiPM_462V_no_trigger, SiPM_000V_no_trigger};
  ...
  max_val*= linear ? 1.2 : 2;
	...
	for (int hh = 0, hh_end_ = pulses.size(); hh!=hh_end_; ++hh) {
		//legend->AddEntry(pulses[hh].hist, (std::string("E_{GEM} = ") + pulses[hh].Td + " kV/cm, " + pulses[hh].device).c_str(), "l");
