...
//S1 + S2 in LAr + N2(620--100 ppm) in thin GEM1
...
//Setup: single-phase, X-ray without collimator,
...
for (int e = 0; e != exp_area.experiments.size(); ++e) {
	...
	S2_times[exp] = std::pair<double, double> (62, 87);
	Bkg_times[exp] = std::pair<double, double> (2, 31.6);
}

std::map<std::string, std::string> exp_folders;
exp_folders["231012_X-ray_S2_LArN2_10kV_923V_850V_46V_no_coll"] = "X-ray_10kV_923V";
exp_folders["231012_X-ray_S2_LArN2_10kV_877V_850V_46V_no_coll"] = "X-ray_10kV_877V";
exp_folders["231012_X-ray_S2_LArN2_10kV_831V_850V_46V_no_coll"] = "X-ray_10kV_831V";
exp_folders["231012_X-ray_S2_LArN2_10kV_785V_850V_46V_no_coll"] = "X-ray_10kV_785V";
exp_folders["231012_X-ray_S2_LArN2_10kV_739V_850V_46V_no_coll"] = "X-ray_10kV_739V";
exp_folders["231012_X-ray_S2_LArN2_10kV_693V_850V_46V_no_coll"] = "X-ray_10kV_693V";
exp_folders["231012_X-ray_S2_LArN2_10kV_646V_850V_46V_no_coll"] = "X-ray_10kV_646V";
exp_folders["231012_X-ray_S2_LArN2_10kV_600V_850V_46V_no_coll"] = "X-ray_10kV_600V";
exp_folders["231012_X-ray_S2_LArN2_10kV_554V_850V_46V_no_coll"] = "X-ray_10kV_554V";
exp_folders["231012_X-ray_S2_LArN2_10kV_508V_850V_46V_no_coll"] = "X-ray_10kV_508V";
exp_folders["231012_X-ray_S2_LArN2_10kV_462V_850V_46V_no_coll"] = "X-ray_10kV_462V";
exp_folders["231012_X-ray_S2_LArN2_10kV_416V_850V_46V_no_coll"] = "X-ray_10kV_416V";
exp_folders["231012_X-ray_S2_LArN2_10kV_369V_850V_46V_no_coll"] = "X-ray_10kV_369V";
exp_folders["231012_X-ray_S2_LArN2_10kV_323V_850V_46V_no_coll"] = "X-ray_10kV_323V";
exp_folders["231012_X-ray_S2_LArN2_10kV_277V_850V_46V_no_coll"] = "X-ray_10kV_277V";
exp_folders["231012_X-ray_S2_LArN2_10kV_231V_850V_46V_no_coll"] = "X-ray_10kV_231V";
exp_folders["231012_X-ray_S2_LArN2_10kV_185V_850V_46V_no_coll"] = "X-ray_10kV_185V";
exp_folders["231012_X-ray_S2_LArN2_10kV_0V_850V_46V_no_coll"] = "X-ray_10kV_000V";
...
//zcxv
if (exp == "231012_X-ray_S2_LArN2_10kV_923V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_877V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_831V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_785V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_739V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_693V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_646V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_600V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_554V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_508V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_462V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_416V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_369V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_323V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_277V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_231V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_185V_850V_46V_no_coll"
	|| exp == "231012_X-ray_S2_LArN2_10kV_0V_850V_46V_no_coll") {
...
set_corr(AStates::PMT_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 500, 0, 200);
	set_bins(500, 200);
	x_y_regions = {0, 0, 460, 0, 460, 100, 0, 100};
	if (exp == "231012_X-ray_S2_LArN2_10kV_923V_850V_46V_no_coll"
		|| exp == "231012_X-ray_S2_LArN2_10kV_877V_850V_46V_no_coll"
		|| exp == "231012_X-ray_S2_LArN2_10kV_831V_850V_46V_no_coll")
		x_y_regions = {0, 0, 250, 0, 250, 60, 0, 60};
	if (exp == "231012_X-ray_S2_LArN2_10kV_785V_850V_46V_no_coll")
		x_y_regions = {0, 0, 280, 0, 280, 50, 0, 50};
	if (exp == "231012_X-ray_S2_LArN2_10kV_739V_850V_46V_no_coll")
		x_y_regions = {0, 0, 250, 0, 250, 20, 210, 45, 0, 45};
	if (exp == "231012_X-ray_S2_LArN2_10kV_693V_850V_46V_no_coll"
		|| exp == "231012_X-ray_S2_LArN2_10kV_646V_850V_46V_no_coll")
		x_y_regions = {0, 0, 260, 0, 260, 50, 0, 50};
	if (exp == "231012_X-ray_S2_LArN2_10kV_600V_850V_46V_no_coll"
		|| exp == "231012_X-ray_S2_LArN2_10kV_554V_850V_46V_no_coll"
		|| exp == "231012_X-ray_S2_LArN2_10kV_508V_850V_46V_no_coll")
		x_y_regions = {0, 0, 280, 0, 280, 50, 0, 50};
	if (exp == "231012_X-ray_S2_LArN2_10kV_462V_850V_46V_no_coll"
		|| exp == "231012_X-ray_S2_LArN2_10kV_416V_850V_46V_no_coll")
		x_y_regions = {0, 0, 290, 0, 290, 50, 0, 50};
	if (exp == "231012_X-ray_S2_LArN2_10kV_369V_850V_46V_no_coll"
		|| exp == "231012_X-ray_S2_LArN2_10kV_323V_850V_46V_no_coll")
		x_y_regions = {0, 0, 310, 0, 310, 50, 0, 50};
	if (exp == "231012_X-ray_S2_LArN2_10kV_277V_850V_46V_no_coll")
		x_y_regions = {0, 0, 330, 0, 330, 50, 0, 50};
	if (exp == "231012_X-ray_S2_LArN2_10kV_231V_850V_46V_no_coll")
		x_y_regions = {0, 0, 350, 0, 350, 50, 0, 50};
	if (exp == "231012_X-ray_S2_LArN2_10kV_185V_850V_46V_no_coll")
		x_y_regions = {0, 0, 370, 0, 370, 55, 0, 55};
	if (exp == "231012_X-ray_S2_LArN2_10kV_0V_850V_46V_no_coll")
		x_y_regions = {0, 0, 420, 0, 420, 55, 0, 55};
