...
//Same as compare_form.cpp but for results_v2
...
int compare_forms2 (std::string in_kV, std::string in_is_linear, std::string in_is_orthogonal,
...
int compare_forms2 (void) {
	...
	double time_pretrigger_left = 5, time_pretrigger_right = 22;
...
define->folder = std::string("210302/results_v2/Pu_46V_7.6kV_800V_120K/") + (orthogonal_tracks ? "forms_Alpha_peak_v1/" : "forms_Alpha_peak_v2/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "6.8";
define->device = "SiPM-matrix, 120K";
define->fast_t_center = 28.8;
define->fast_t = PAIR(40, 71.2);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(71.9, 148);
define->long_fit_t = PAIR(71.9, 148);
...
define->fast_t = PAIR(40, 68.0);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(70.4, 152);
define->long_fit_t = PAIR(70.4, 152);
define->baseline_bound = PAIR(1e-6, 1e-5);
...
define->fit_option = def_fit_option;
	...
	std::string folder = PMTs ? std::string("210302/results_v2/PMTs/")
					: std::string("210302/results_v2/SiPMs/");
#ifdef FAST_FIGURES_MODE
