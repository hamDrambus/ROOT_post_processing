...
define->folder = std::string("210128/results_v5/Pu_46V_19kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
...
define->folder = std::string("210128/results_v5/Pu_46V_18kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "7.7";
define->device = "SiPM-matrix";
define->fast_t_center = 29.0;
...
define->folder = std::string("210128/results_v5/Pu_46V_14kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "6.0";
define->device = "SiPM-matrix";
define->fast_t_center = 29.1;
...
define->folder = std::string("210128/results_v5/Pu_46V_13kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "5.6";
define->device = "SiPM-matrix";
...
define->folder = std::string("210128/results_v5/Pu_46V_12kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "5.1";
define->device = "SiPM-matrix";
...
define->folder = std::string("210128/results_v5/Pu_46V_11kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.7";
define->device = "SiPM-matrix";
...
define->folder = std::string("210128/results_v5/Pu_46V_10kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.3";
define->device = "SiPM-matrix";
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.4, 130);
define->long_fit_t = PAIR(33.4, 130);
define->baseline_bound = PAIR(1e-6, 2e-5);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(3e-4, 1e-2);
...
define->folder = std::string("210128/results_v5/Pu_46V_09kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "3.8";
define->device = "SiPM-matrix";
...
define->simultaneous_fit = false;
	...
	std::string folder = PMTs ? std::string("210128/results_v5/PMTs_v1/")
					: std::string("210128/results_v5/SiPMs_v1/");
#ifdef FAST_FIGURES_MODE
	...
	//std::vector<pulse_shape> pulses = {SiPM_13kV_no_trigger, SiPM_12kV_no_trigger, SiPM_11kV_no_trigger, SiPM_10kV_no_trigger, SiPM_09kV_no_trigger};
	...
	//std::vector<pulse_shape> pulses = {PMT4_13kV_no_trigger, PMT4_12kV_no_trigger, PMT4_11kV_no_trigger, PMT4_10kV_no_trigger, PMT4_09kV_no_trigger};
