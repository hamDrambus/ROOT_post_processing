...
//For 210902/results_v5, same as 210513/compare_forms1.cpp
//16.1 mm with 238Pu set on the cathode. (Mesh instead of THGEM0, 28% CERN #8 as THEGEM1, PMT#1 malfunctions due to mixed signal wires)
...
int compare_forms1 (void) {
	...
	double time_pretrigger_left = 3.5, time_pretrigger_right = 17.0;
...
define->folder = std::string("210902/results_v5/Pu_46V_16kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "7.1";
define->device = "SiPM-matrix";
define->fast_t_center = 29.4;
define->fast_t = PAIR(22.0, 31.8);
...
*define = *copy;
define->slow_fit_t = PAIR(32.8, 40.5);
...
define->folder = std::string("210902/results_v5/Pu_46V_14kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "6.2";
define->device = "SiPM-matrix";
define->fast_t_center = 29.6;
define->fast_t = PAIR(22.0, 32.1);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->folder = std::string("210902/results_v5/Pu_46V_13kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "5.8";
define->device = "SiPM-matrix";
define->fast_t_center = 29.6;
...
*define = *copy;
define->slow_fit_t = PAIR(33.7, 41.5);
...
define->folder = std::string("210902/results_v5/Pu_46V_12kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "5.3";
define->device = "SiPM-matrix";
define->fast_t_center = 29.8;
define->fast_t = PAIR(21.0, 32.9);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
*define = *copy;
define->slow_fit_t = PAIR(33.9, 42.1);
define->long_fit_t = PAIR(60, 154);
define->baseline_bound = PAIR(1e-6, 7.7e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(5e-3, 1.9e-2);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->folder = std::string("210902/results_v5/Pu_46V_11kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.9";
define->device = "SiPM-matrix";
define->fast_t_center = 29.8;
define->fast_t = PAIR(21.0, 33.2);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 6e-4);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(34.4, 42.2);
define->long_fit_t = PAIR(59, 154);
define->baseline_bound = PAIR(1e-6, 5e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-3, 9.4e-3);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 5e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
define->folder = std::string("210902/results_v5/Pu_46V_10kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.4";
define->device = "SiPM-matrix";
...
*define = *copy;
define->slow_fit_t = PAIR(34.7, 43.0);
define->long_fit_t = PAIR(56, 154);
define->baseline_bound = PAIR(1e-6, 3.3e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 6.3e-3);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(3e-5, 1e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
define->folder = std::string("210902/results_v5/Pu_46V_09kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.0";
define->device = "SiPM-matrix";
define->fast_t_center = 29.9;
define->fast_t = PAIR(21.0, 34.0);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(34.8, 154);
define->long_fit_t = PAIR(34.8, 154);
define->baseline_bound = PAIR(1e-6, 1e-6);
...
*define = *copy;
define->slow_fit_t = PAIR(36.0, 52.0);
define->long_fit_t = PAIR(63, 154);
define->baseline_bound = PAIR(1e-6, 2.1e-5);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 1e-2);
define->slow_tau_bound = PAIR(2.5, 12);
define->long_ampl_bound = PAIR(2e-5, 1e-3);
...
define->folder = std::string("210902/results_v5/Pu_46V_08kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "3.6";
define->device = "SiPM-matrix";
define->fast_t_center = 29.5;
define->fast_t = PAIR(21.0, 33.8);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(34.4, 154);
define->long_fit_t = PAIR(34.4, 154);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 1e-2);
define->slow_tau_bound = PAIR(2.5, 12);
define->long_ampl_bound = PAIR(2e-5, 2e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(36.5, 57.0);
define->long_fit_t = PAIR(68, 154);
define->baseline_bound = PAIR(1e-6, 1.7e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2.2e-3, 2e-2);
define->slow_tau_bound = PAIR(2.5, 12);
define->long_ampl_bound = PAIR(2e-5, 2e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
*define = *copy;
define->slow_fit_t = PAIR(34.1, 40.7);
define->long_fit_t = PAIR(60, 155);
...
*define = *copy;
define->slow_fit_t = PAIR(34.9, 41.3);
define->long_fit_t = PAIR(59, 155);
define->baseline_bound = PAIR(1e-6, 1e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(5e-3, 1.5e-2);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(4e-3, 4e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(2e-4, 5e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
...
*define = *copy;
define->slow_fit_t = PAIR(35.0, 40.3);
define->long_fit_t = PAIR(53, 155);
define->baseline_bound = PAIR(1e-6, 8.0e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(3e-3, 9.5e-3);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(2e-4, 5e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(2e-4, 6e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(34.5, 41.4);
define->long_fit_t = PAIR(52, 155);
define->baseline_bound = PAIR(1e-6, 5.7e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-3, 6.3e-3);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(2e-4, 6e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
define->slow_ampl_bound = PAIR(1e-3, 1e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(9e-5, 1e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
if (!fast_PMTs) define->device += " (slow)";
define->fast_t_center = 29.7;
define->fast_t = PAIR(22.0, 34.3);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(34.5, 155);
define->long_fit_t = PAIR(34.5, 155);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 1e-2);
define->slow_tau_bound = PAIR(2.5, 10);
...
*define = *copy;
define->slow_fit_t = PAIR(35.4, 45.8);
define->long_fit_t = PAIR(57, 155);
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(34.2, 155);
define->long_fit_t = PAIR(34.2, 155);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 2e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(8e-5, 1e-3);
...
*define = *copy;
define->slow_fit_t = PAIR(35.5, 49);
define->long_fit_t = PAIR(57.5, 155);
define->baseline_bound = PAIR(1e-6, 5.2e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 2e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(8e-5, 1e-3);
...
define->simultaneous_fit = false;
	...
	std::string folder = PMTs ? std::string("210902/results_v5/PMTs_v1/")
					: std::string("210902/results_v5/SiPMs_v1/");
	//std::vector<pulse_shape> pulses = {SiPM_16kV_no_trigger, SiPM_14kV_no_trigger, SiPM_13kV_no_trigger, SiPM_12kV_no_trigger};
	//std::vector<pulse_shape> pulses = {SiPM_11kV_no_trigger, SiPM_10kV_no_trigger, SiPM_09kV_no_trigger, SiPM_08kV_no_trigger};
	//std::vector<pulse_shape> pulses = {SiPM_16kV_no_trigger_v2, SiPM_14kV_no_trigger_v2, SiPM_13kV_no_trigger_v2, SiPM_12kV_no_trigger_v2};
	...
	//std::vector<pulse_shape> pulses = {PMT4_16kV_no_trigger, PMT4_14kV_no_trigger, PMT4_13kV_no_trigger, PMT4_12kV_no_trigger};
	std::vector<pulse_shape> pulses = {PMT4_11kV_no_trigger, PMT4_10kV_no_trigger, PMT4_09kV_no_trigger, PMT4_08kV_no_trigger};
	//std::vector<pulse_shape> pulses = {PMT4_16kV_no_trigger_v2, PMT4_14kV_no_trigger_v2, PMT4_13kV_no_trigger_v2, PMT4_12kV_no_trigger_v2};
