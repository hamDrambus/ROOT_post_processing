{
  ...
  data_prefix_path = "../Data/210902/results_v1/";
  ...
  exp_area.experiments.push_back("210902_Pu_16kV_850V_46V_12dB");
  exp_area.experiments.push_back("210902_Pu_14kV_850V_46V_12dB");
  exp_area.experiments.push_back("210902_Pu_13kV_850V_46V_12dB");
  exp_area.experiments.push_back("210902_Pu_12kV_850V_46V_12dB");
  exp_area.experiments.push_back("210902_Pu_11kV_850V_46V_12dB");
  exp_area.experiments.push_back("210902_Pu_10kV_850V_46V_12dB");
  exp_area.experiments.push_back("210902_Pu_9kV_850V_46V_12dB");
  exp_area.experiments.push_back("210902_Pu_8kV_850V_46V_12dB");
  ...
  experiment_fields["210902_Pu_16kV_850V_46V_12dB"] = 16;
  experiment_fields["210902_Pu_14kV_850V_46V_12dB"] = 14;
  experiment_fields["210902_Pu_13kV_850V_46V_12dB"] = 13;
  experiment_fields["210902_Pu_12kV_850V_46V_12dB"] = 12;
  experiment_fields["210902_Pu_11kV_850V_46V_12dB"] = 11;
  experiment_fields["210902_Pu_10kV_850V_46V_12dB"] = 10;
  experiment_fields["210902_Pu_9kV_850V_46V_12dB"] = 9;
  experiment_fields["210902_Pu_8kV_850V_46V_12dB"] = 8;

  std::map<std::string, int> experiment_runs; //required for printing accpeted/rejected events
  experiment_runs["210902_Pu_16kV_850V_46V_12dB"] = 280;
  experiment_runs["210902_Pu_14kV_850V_46V_12dB"] = 244;
  experiment_runs["210902_Pu_13kV_850V_46V_12dB"] = 206;
  experiment_runs["210902_Pu_12kV_850V_46V_12dB"] = 165;
  experiment_runs["210902_Pu_11kV_850V_46V_12dB"] = 124;
  experiment_runs["210902_Pu_10kV_850V_46V_12dB"] = 83;
  experiment_runs["210902_Pu_9kV_850V_46V_12dB"] = 42;
  experiment_runs["210902_Pu_8kV_850V_46V_12dB"] = 1;
