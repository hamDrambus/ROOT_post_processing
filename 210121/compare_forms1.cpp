...
//When on, compare_forms1 is called with parameters to analyze pulse-shape and save it
...
int compare_forms1 (std::string in_kV, std::string in_is_linear, std::string in_is_Cd_peak,
...
define->folder = std::string("210121/results_v5/Pu_46V_20kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "9.4";
define->device = "SiPM-matrix";
define->fast_t_center = 28.6;
define->fast_t = PAIR(23, 30.2);
...
define->slow_ampl_bound = PAIR(1e-3, 1.7e-1);
...
define->folder = std::string("210121/results_v5/Pu_46V_18kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "8.4";
define->device = "SiPM-matrix";
define->fast_t_center = 28.6;
define->fast_t = PAIR(24, 30.3);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->baseline_bound = PAIR(1e-6, 3e-5);
define->slow_ampl_bound = PAIR(1e-3, 1.3e-1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(3e-4, 1e-1);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
...
define->folder = std::string("210121/results_v5/Pu_46V_16kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "7.5";
define->device = "SiPM-matrix";
define->fast_t_center = 28.6;
define->fast_t = PAIR(23.5, 30.66);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->folder = std::string("210121/results_v5/Pu_46V_15kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "7.0";
define->device = "SiPM-matrix";
define->fast_t_center = 28.6;
...
define->folder = std::string("210121/results_v5/Pu_46V_14kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "6.6";
define->device = "SiPM-matrix";
define->fast_t_center = 28.7;
define->fast_t = PAIR(23, 30.55);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->folder = std::string("210121/results_v5/Pu_46V_13kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "6.1";
define->device = "SiPM-matrix";
...
define->folder = std::string("210121/results_v5/Pu_46V_12kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "5.6";
define->device = "SiPM-matrix";
define->fast_t_center = 28.8;
...
define->baseline_bound = PAIR(1e-6, 1.3e-5);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->folder = std::string("210121/results_v5/Pu_46V_11kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "5.1";
define->device = "SiPM-matrix";
define->fast_t_center = 28.8;
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(32.7, 153);
define->long_fit_t = PAIR(32.7, 153);
define->baseline_bound = PAIR(1e-6, 1.3e-5);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(3e-4, 1e-2);
...
define->folder = std::string("210121/results_v5/Pu_46V_10kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.7";
define->device = "SiPM-matrix";
define->fast_t_center = 28.8;
define->fast_t = PAIR(23, 31.5);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(32.4, 152);
define->long_fit_t = PAIR(32.4, 152);
define->baseline_bound = PAIR(1e-6, 1.3e-5);
define->slow_ampl_bound = PAIR(1e-3, 1e-1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(2e-5, 3e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
...
define->folder = std::string("210121/results_v5/Pu_46V_8.9kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.2";
define->device = "SiPM-matrix";
define->fast_t_center = 28.7;
define->fast_t = PAIR(22, 31.55);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(3e-4, 2.2e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit && fit_bad_forms;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(32.1, 41.9);
define->long_fit_t = PAIR(75, 156);
define->baseline_bound = PAIR(1e-6, 5e-3);
define->long_baseline_bound = PAIR(1e-6, 2e-5);
define->slow_ampl_bound = PAIR(1e-2, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(2.7e-3, 1e-1);
define->long_tau_bound = PAIR(15, 200);
...
define->long_fit_t = PAIR(72, 157);
define->baseline_bound = PAIR(1e-6, 3.5e-3);
define->long_baseline_bound = PAIR(1e-6, 2e-5);
define->slow_ampl_bound = PAIR(1e-2, 1);
define->slow_tau_bound = PAIR(2.5, 10);
...
*define = *copy;
define->slow_fit_t = PAIR(32.9, 40.3);
define->long_fit_t = PAIR(67, 156);
...
*define = *copy;
define->slow_fit_t = PAIR(33.1, 40.9);
...
*define = *copy;
define->slow_fit_t = PAIR(33.2, 41.1);
define->long_fit_t = PAIR(70, 155);
define->baseline_bound = PAIR(1e-6, 1e-3);
define->long_baseline_bound = PAIR(1e-6, 2e-5);
define->slow_ampl_bound = PAIR(1e-3, 0.1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 8e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
define->long_baseline_bound = PAIR(1e-6, 2e-5);
define->slow_ampl_bound = PAIR(1e-3, 1.6e-2);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->long_fit_t = PAIR(66, 150);
define->baseline_bound = PAIR(1e-6, 2e-4);
define->long_baseline_bound = PAIR(1e-6, 1.3e-5);
define->slow_ampl_bound = PAIR(1e-3, 2e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(5e-5, 2e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
define->fast_t = PAIR(25, 29.9);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(32.4, 156);
define->long_fit_t = PAIR(32.4, 156);
define->baseline_bound = PAIR(1e-6, 2e-5);
define->slow_ampl_bound = PAIR(1e-2, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-3, 0.1);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
define->baseline_bound = PAIR(1e-6, 2e-5);
define->slow_ampl_bound = PAIR(1e-2, 5.5e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(4e-4, 1e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.2, 156);
define->long_fit_t = PAIR(33.2, 156);
define->baseline_bound = PAIR(1e-6, 2e-5);
define->slow_ampl_bound = PAIR(2e-3, 2e-1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 1e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
...
define->device = copy->device;
define->fast_t_center = 28.6;
define->fast_t = PAIR(23.5, 30.9);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.0, 156);
define->long_fit_t = PAIR(33.0, 156);
define->baseline_bound = PAIR(1e-6, 2e-5);
define->slow_ampl_bound = PAIR(2e-3, 2e-1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 1e-2);
...
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 4.5e-3);
...
define->baseline_bound = PAIR(1e-6, 2e-5);
define->slow_ampl_bound = PAIR(6e-4, 2e-2);
define->slow_tau_bound = PAIR(3.0, 10);
define->long_ampl_bound = PAIR(1e-5, 2e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
define->baseline_bound = PAIR(1e-6, 2e-5);
define->slow_ampl_bound = PAIR(3e-4, 2e-2);
define->slow_tau_bound = PAIR(2.5, 10);
...
*define = *copy;
define->slow_fit_t = PAIR(33.2, 41.3);
define->long_fit_t = PAIR(70, 155);
...
*define = *copy;
define->slow_fit_t = PAIR(33.9, 42.2);
define->long_fit_t = PAIR(69, 153);
define->baseline_bound = PAIR(1e-6, 2e-3);
define->long_baseline_bound = PAIR(1e-6, 2e-5);
...
*define = *copy;
define->slow_fit_t = PAIR(33.9, 42.8);
define->long_fit_t = PAIR(58, 155);
define->baseline_bound = PAIR(1e-6, 1.5e-3);
define->long_baseline_bound = PAIR(1e-6, 2e-5);
define->slow_ampl_bound = PAIR(2e-3, 0.1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 1e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
define->slow_ampl_bound = PAIR(1e-3, 1e-1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(8e-5, 1e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
*define = *copy;
define->slow_fit_t = PAIR(35.5, 45.8);
define->long_fit_t = PAIR(58, 155);
define->baseline_bound = PAIR(1e-6, 2.5e-4);
define->long_baseline_bound = PAIR(1e-6, 1.5e-5);
define->slow_ampl_bound = PAIR(3e-4, 1e-2);
...
*define = *copy;
define->slow_fit_t = PAIR(35.5, 46.0);
define->long_fit_t = PAIR(64, 155);
define->baseline_bound = PAIR(1e-6, 2e-4);
define->long_baseline_bound = PAIR(1e-7, 2e-5);
define->slow_ampl_bound = PAIR(6e-4, 1e-2);
define->slow_tau_bound = PAIR(2.5, 15);
define->long_ampl_bound = PAIR(1e-5, 2e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
*define = *copy;
define->slow_fit_t = PAIR(36.5, 48.4);
define->long_fit_t = PAIR(69, 155);
define->baseline_bound = PAIR(1e-6, 1e-4);
define->long_baseline_bound = PAIR(1e-7, 1e-5);
define->slow_ampl_bound = PAIR(3e-4, 6e-2);
define->slow_tau_bound = PAIR(2.5, 15);
define->long_ampl_bound = PAIR(1e-4, 0.1);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;

	std::string folder = PMTs ? std::string("210121/results_v5/PMTs_v1/")
					: std::string("210121/results_v5/SiPMs_v1/");
#ifdef FAST_FIGURES_MODE
...
#else //FAST_FIGURES_MODE
	//std::vector<pulse_shape> pulses = {PMT4_20kV_no_trigger_v2};
	//std::vector<pulse_shape> pulses = {SiPM_20kV_no_trigger, SiPM_18kV_no_trigger, SiPM_16kV_no_trigger, SiPM_15kV_no_trigger, SiPM_14kV_no_trigger};
	std::vector<pulse_shape> pulses = {SiPM_13kV_no_trigger, SiPM_12kV_no_trigger, SiPM_11kV_no_trigger, SiPM_10kV_no_trigger, SiPM_08_9kV_no_trigger};
	//std::vector<pulse_shape> pulses = {SiPM_20kV_no_trigger_v2, SiPM_18kV_no_trigger_v2, SiPM_16kV_no_trigger_v2, SiPM_15kV_no_trigger_v2, SiPM_14kV_no_trigger_v2};
	//std::vector<pulse_shape> pulses = {SiPM_13kV_no_trigger_v2, SiPM_12kV_no_trigger_v2, SiPM_11kV_no_trigger_v2, SiPM_10kV_no_trigger_v2, SiPM_08_9kV_no_trigger_v2};

	//std::vector<pulse_shape> pulses = {PMT4_20kV_no_trigger, PMT4_18kV_no_trigger, PMT4_16kV_no_trigger, PMT4_15kV_no_trigger, PMT4_14kV_no_trigger};
	//std::vector<pulse_shape> pulses = {PMT4_13kV_no_trigger, PMT4_12kV_no_trigger, PMT4_11kV_no_trigger, PMT4_10kV_no_trigger, PMT4_08_9kV_no_trigger};
	//std::vector<pulse_shape> pulses = {PMT4_20kV_no_trigger_v2, PMT4_18kV_no_trigger_v2, PMT4_16kV_no_trigger_v2, PMT4_15kV_no_trigger_v2, PMT4_14kV_no_trigger_v2};
	//std::vector<pulse_shape> pulses = {PMT4_13kV_no_trigger_v2, PMT4_12kV_no_trigger_v2, PMT4_11kV_no_trigger_v2, PMT4_10kV_no_trigger_v2, PMT4_08_9kV_no_trigger_v2};
