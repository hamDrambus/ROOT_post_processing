...
S2_times["210121_Pu_20kV_850V_46V_12dB"] = std::pair<double, double> (22, 34);
...
pre_trigger_max_S["210121_Pu_20kV_850V_46V_12dB"] = 0.52;
pre_trigger_max_S["210121_Pu_18kV_850V_46V_12dB"] = 0.36;
pre_trigger_max_S["210121_Pu_16kV_850V_46V_12dB"] = 0.29;
pre_trigger_max_S["210121_Pu_15kV_850V_46V_12dB"] = 0.29;
pre_trigger_max_S["210121_Pu_14kV_850V_46V_12dB"] = 0.23;
pre_trigger_max_S["210121_Pu_13kV_850V_46V_12dB"] = 0.23;
pre_trigger_max_S["210121_Pu_12kV_850V_46V_12dB"] = 0.16;
pre_trigger_max_S["210121_Pu_11kV_850V_46V_12dB"] = 0.16;
pre_trigger_max_S["210121_Pu_10kV_850V_46V_12dB"] = 0.16;
pre_trigger_max_S["210121_Pu_8.9kV_850V_46V_12dB"] = 0.16;
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_bins(800);
	x_y_regions = {178, 0, 411, 122, 799, 363};
...
if (exp == "210121_Pu_16kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
if (exp == "210121_Pu_15kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
if (exp == "210121_Pu_14kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
if (exp == "210121_Pu_13kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
if (exp == "210121_Pu_12kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
if (exp == "210121_Pu_11kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
if (exp == "210121_Pu_10kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
if (exp == "210121_Pu_8.9kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
