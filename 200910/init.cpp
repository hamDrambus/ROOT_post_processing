{
  ...
  data_prefix_path = "../Data/200910/results_v1/";
  ...
  exp_area.experiments.push_back("Pu_20kV_850V_46V_12dB_th100mV");
  exp_area.experiments.push_back("Pu_20kV_850V_46V_12dB_th130mV");
  exp_area.experiments.push_back("Pu_18kV_850V_46V_12dB_th90mV");
  exp_area.experiments.push_back("Pu_16kV_850V_46V_12dB_th90mV");
  exp_area.experiments.push_back("Pu_12kV_850V_46V_12dB_th86mV");
  exp_area.experiments.push_back("Pu_10kV_850V_46V_12dB_th86mV");
  ...
  experiment_fields["Pu_20kV_850V_46V_12dB_th100mV"] = 20;
  experiment_fields["Pu_20kV_850V_46V_12dB_th130mV"] = 20;
  experiment_fields["Pu_18kV_850V_46V_12dB_th90mV"] = 18;
  experiment_fields["Pu_16kV_850V_46V_12dB_th90mV"] = 16;
  experiment_fields["Pu_12kV_850V_46V_12dB_th86mV"] = 12;
  experiment_fields["Pu_10kV_850V_46V_12dB_th86mV"] = 10;

  std::map<std::string, int> experiment_runs; //required for printing accpeted/rejected events
  experiment_runs["Pu_20kV_850V_46V_12dB_th100mV"] = 167;
  experiment_runs["Pu_20kV_850V_46V_12dB_th130mV"] = 209;
  experiment_runs["Pu_18kV_850V_46V_12dB_th90mV"] = 225;
  experiment_runs["Pu_16kV_850V_46V_12dB_th90mV"] = 270;
  experiment_runs["Pu_12kV_850V_46V_12dB_th86mV"] = 292;
  experiment_runs["Pu_10kV_850V_46V_12dB_th86mV"] = 314;
