...
// Analyzing only S1 in pure LAr. Analyzing S1+S2(gas) is in another file.
...
// Setup: single-phase, X-ray with different collimators,
...
data_output_path = "240215/results_v2/";
...
exp_folders["240215_Ar_1ph_X-ray_14mm_coll_20kV_850V_46V"] = "X-ray_14mm_coll_20kV";
exp_folders["240215_Ar_1ph_X-ray_14mm_coll_18kV_850V_46V"] = "X-ray_14mm_coll_18kV";
exp_folders["240215_Ar_1ph_X-ray_14mm_coll_16kV_850V_46V"] = "X-ray_14mm_coll_16kV";
exp_folders["240215_Ar_1ph_X-ray_14mm_coll_14kV_850V_46V"] = "X-ray_14mm_coll_14kV";
exp_folders["240215_Ar_1ph_X-ray_14mm_coll_12kV_850V_46V"] = "X-ray_14mm_coll_12kV";
exp_folders["240215_Ar_1ph_X-ray_14mm_coll_10kV_850V_46V"] = "X-ray_14mm_coll_10kV";
exp_folders["240215_Ar_1ph_X-ray_14mm_coll_8kV_850V_46V"] = "X-ray_14mm_coll_08kV";
exp_folders["240215_Ar_1ph_X-ray_14mm_coll_0kV_850V_46V"] = "X-ray_14mm_coll_00kV";
exp_folders["240215_Ar_1ph_X-ray_6mm_coll_20kV_850V_46V"] = "X-ray_6mm_coll_20kV";
exp_folders["240215_Ar_1ph_X-ray_6mm_coll_18kV_850V_46V"] = "X-ray_6mm_coll_18kV";
exp_folders["240215_Ar_1ph_X-ray_6mm_coll_16kV_850V_46V"] = "X-ray_6mm_coll_16kV";
exp_folders["240215_Ar_1ph_X-ray_6mm_coll_14kV_850V_46V"] = "X-ray_6mm_coll_14kV";
exp_folders["240215_Ar_1ph_X-ray_6mm_coll_12kV_850V_46V"] = "X-ray_6mm_coll_12kV";
exp_folders["240215_Ar_1ph_X-ray_6mm_coll_10kV_850V_46V"] = "X-ray_6mm_coll_10kV";
exp_folders["240215_Ar_1ph_X-ray_6mm_coll_8kV_850V_46V"] = "X-ray_6mm_coll_08kV";
exp_folders["240215_Ar_1ph_X-ray_6mm_coll_0kV_850V_46V"] = "X-ray_6mm_coll_00kV";
...
auto do_SiPM_vs_PMT_Npe_figures = [&] (const std::pair<unsigned int, unsigned int> &max_Npe,
    ...
    // This comment is for working in interpreter
    // std::pair<unsigned int, unsigned int> max_Npe(200, 100); \
...
auto do_SiPM_vs_PMT_Npe_figures_log = [&] (const std::pair<unsigned int, unsigned int> &max_Npe,
                                       ...
                                       const std::vector<double> &x_y_select_region) {
    // This comment is for working in interpreter
    // std::pair<unsigned int, unsigned int> max_Npe(1000, 1000); \
    std::pair<unsigned int, unsigned int> N_bins(200, 200); \
    std::vector<double> x_y_select_region = \
    {0, 0, 40, 0, 40, 15, 0, 15};
    set_corr(AStates::PMT_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
    ty(AStates::Correlation);
...
if (exp == "240215_Ar_1ph_X-ray_14mm_coll_20kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_14mm_coll_18kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_14mm_coll_16kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_14mm_coll_14kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_14mm_coll_12kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_14mm_coll_10kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_14mm_coll_8kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_14mm_coll_0kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_6mm_coll_20kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_6mm_coll_18kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_6mm_coll_16kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_6mm_coll_14kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_6mm_coll_12kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_6mm_coll_10kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_6mm_coll_8kV_850V_46V"
    || exp == "240215_Ar_1ph_X-ray_6mm_coll_0kV_850V_46V") {
    ...
    if (exp == "240215_Ar_1ph_X-ray_14mm_coll_20kV_850V_46V"
        ...
        x_y_regions = {0, 0, 75, 0, 75, 10, 0, 10};
    }
    if (exp == "240215_Ar_1ph_X-ray_6mm_coll_20kV_850V_46V"
        || exp == "240215_Ar_1ph_X-ray_6mm_coll_18kV_850V_46V"
        || exp == "240215_Ar_1ph_X-ray_6mm_coll_16kV_850V_46V"
        || exp == "240215_Ar_1ph_X-ray_6mm_coll_14kV_850V_46V"
        || exp == "240215_Ar_1ph_X-ray_6mm_coll_12kV_850V_46V"
        ...
        do_SiPM_Npe_figures(100u);
        x_y_regions = {0, 0, 25, 0, 25, 10, 0, 10};
    }

    do_SiPM_vs_PMT_Npe_figures_log(std::make_pair(1000u, 1000u),
                               std::make_pair(200u, 200u),
                               x_y_regions);
    do_SiPM_vs_PMT_Npe_figures(std::make_pair(200u, 100u),
                               std::make_pair(0u, 0u),
                               x_y_regions);
    ...
    do_SiPM_PMT_Npe_tables(100u, 100u);
}
//END OF FORMS
}
