...
int subtract_forms1 (void) {
  ...
  pulse_shape SiPM_20_0kV_no_trigger_3;
	define = &SiPM_20_0kV_no_trigger_3;
define->folder = std::string("211007/results_v5/Pu_46V_19.8kV_800V_2500V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_edge_form_by_Npe.hdata"};
define->file_type = ShapeFileType::Histogram;
define->Td = "8.5";
define->device = "SiPM-matrix, 2500V";
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_20_0kV_no_trigger_2;
	define = &SiPM_20_0kV_no_trigger_2;
define->folder = std::string("211007/results_v5/Pu_46V_19.9kV_800V_2550V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_edge_form_by_Npe.hdata"};
define->file_type = ShapeFileType::Histogram;
define->Td = "8.5";
define->device = "SiPM-matrix, 2550V";
define->fast_t_center = 28.4;
define->fast_t = PAIR(24.5, 29.6);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_20_0kV_no_trigger_1;
	define = &SiPM_20_0kV_no_trigger_1;
define->folder = std::string("211007/results_v5/Pu_46V_19.9kV_800V_2600V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_edge_form_by_Npe.hdata"};
define->file_type = ShapeFileType::Histogram;
define->Td = "8.5";
define->device = "SiPM-matrix, 2600V";
define->fast_t_center = 28.4;
define->fast_t = PAIR(24.5, 29.6);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
...
define->folder = std::string("211007/results_v5/Pu_46V_20.0kV_800V_2650V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_edge_form_by_Npe.hdata"};
define->file_type = ShapeFileType::Histogram;
define->Td = "8.3";
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_18_8kV_no_trigger;
  define = &SiPM_18_8kV_no_trigger;
...
define->subtract_baseline = subtract_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.1, 47.5);
define->long_fit_t = PAIR(91, 154);
define->baseline_bound = PAIR(1e-6, 2.0e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(5e-2, 5e-1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-3, 2e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_17_0kV_no_trigger;
  define = &SiPM_17_0kV_no_trigger;
...
define->subtract_baseline = subtract_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.2, 47.0);
define->long_fit_t = PAIR(89, 154);
define->baseline_bound = PAIR(1e-6, 1.9e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(5e-2, 3e-1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(7e-4, 5e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
define->do_fit = do_fit;
define->fit_option = def_fit_option;

  pulse_shape SiPM_15_3kV_no_trigger;
  define = &SiPM_15_3kV_no_trigger;
...
define->subtract_baseline = subtract_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.8, 47.0);
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_14_4kV_no_trigger;
  define = &SiPM_14_4kV_no_trigger;
...
define->subtract_baseline = subtract_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(34.0, 47.0);
define->long_fit_t = PAIR(86, 154);
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_13_6kV_no_trigger;
  define = &SiPM_13_6kV_no_trigger;
...
define->subtract_baseline = subtract_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(34.3, 46.2);
define->long_fit_t = PAIR(86, 154);
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_12_7kV_no_trigger;
  define = &SiPM_12_7kV_no_trigger;
...
define->fit_option = def_fit_option;
  ...
  pulse_shape Q_20_0kV_no_trigger_3;
  define = &Q_20_0kV_no_trigger_3;
define->folder = std::string("../Data/211007/results_v2/211007_Pu_19.8kV_800V_46V_12dB_2500V/Charge_10/");
define->fnames.push_back("Charge211007_Pu_19.8kV_800V_46V_12dB_2500V_ch_10_AVR_0");
define->file_type = ShapeFileType::RawNoError;
define->Td = "8.5";
define->device = "Charge, 2500V";
...
define->slow_ampl_bound = PAIR(1e-1, 4e-1);
...
define->fit_option = "NRWE";
  ...
  pulse_shape Q_20_0kV_no_trigger_2;
  define = &Q_20_0kV_no_trigger_2;
define->folder = std::string("../Data/211007/results_v2/211007_Pu_19.9kV_800V_46V_12dB_2550V/Charge_10/");
define->fnames.push_back("Charge211007_Pu_19.9kV_800V_46V_12dB_2550V_ch_10_AVR_0");
define->file_type = ShapeFileType::RawNoError;
define->Td = "8.5";
define->device = "Charge, 2550V";
define->fast_t_center = 30.9;
define->fast_t = PAIR(29.7, 2*30.94 - 29.70);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
...
define->fit_option = "NRWE";
  ...
  pulse_shape Q_20_0kV_no_trigger_1;
  define = &Q_20_0kV_no_trigger_1;
define->folder = std::string("../Data/211007/results_v2/211007_Pu_19.9kV_800V_46V_12dB_2600V/Charge_10/");
define->fnames.push_back("Charge211007_Pu_19.9kV_800V_46V_12dB_2600V_ch_10_AVR_0");
define->file_type = ShapeFileType::RawNoError;
define->Td = "8.5";
define->device = "Charge, 2600V";
define->fast_t_center = 30.9;
define->fast_t = PAIR(29.7, 2*30.94 - 29.70);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
...
define->fit_option = "NRWE";
  ...
  pulse_shape Q_18_8kV_no_trigger;
  define = &Q_18_8kV_no_trigger;
...
define->fit_option = "NRWE";
  ...
  pulse_shape Q_17_0kV_no_trigger;
  define = &Q_17_0kV_no_trigger;
...
define->fit_option = "NRWE";
  ...
  pulse_shape Q_15_3kV_no_trigger;
  define = &Q_15_3kV_no_trigger;
...
define->fit_option = "NRWE";
  ...
  pulse_shape Q_14_4kV_no_trigger;
  define = &Q_14_4kV_no_trigger;
...
define->fit_option = "NRWE";
  ...
  pulse_shape Q_13_6kV_no_trigger;
  define = &Q_13_6kV_no_trigger;
...
define->fit_option = "NRWE";
  ...
  pulse_shape Q_12_7kV_no_trigger;
  define = &Q_12_7kV_no_trigger;
...
define->fit_option = "NRWE";
  ...
  pulse_shape Q_11_8kV_no_trigger;
  define = &Q_11_8kV_no_trigger;
...
define->fit_option = "NRWE";
	...
	pulse_shape Q_11_0kV_no_trigger;
	define = &Q_11_0kV_no_trigger;
...
define->fit_option = "NRWE";
  ...
  std::vector<std::string> forced_taus1, forced_Frs1;
    ...
    framename = std::string("Results for charge (no WLS), ")+(Cd_peak ? "" : "< ")+"5.5 MeV #alpha ^{238}Pu";
  ...
  max_val*= linear ? 1.2 : 2;
	...
	TH2F* frame = new TH2F("frame", framename.c_str(), 500, time_left, time_right, 500, linear ? (SiPMs ? 0 : -0.3) : y_min, max_val);
