...
//Same as ncompare_form.cpp but with larger Nbins to
//better fit slow component. In exchange has worse long component.
...
//compare_forms("20", "lin", "peak", 1800, "NLWRE", "comb");
int compare_forms (std::string in_kV, std::string in_is_linear, std::string in_is_Cd_peak,
...
int compare_forms (void) {
	...
	pulse_shape SiPM_16_3kV_no_trigger;
	define = &SiPM_16_3kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_16.3kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "9.0";
define->device = "SiPM-matrix";
define->fast_t_center = 28.8;
define->fast_t = PAIR(23, 29.5);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(30.0, 155);
define->long_fit_t = PAIR(30.0, 155);
...
define->fit_option = def_fit_option;
	...
	pulse_shape SiPM_14_6kV_no_trigger;
	define = &SiPM_14_6kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_14.6kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "8.1";
define->device = "SiPM-matrix";
define->fast_t_center = 28.8;
define->fast_t = PAIR(23, 29.6);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->fit_option = def_fit_option;
	...
	pulse_shape SiPM_13_0kV_no_trigger;
	define = &SiPM_13_0kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_13.0kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "7.2";
define->device = "SiPM-matrix";
define->fast_t_center = 28.8;
define->fast_t = PAIR(23, 29.8);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(30.2, 155);
define->long_fit_t = PAIR(30.2, 155);
...
define->fit_option = def_fit_option;
	...
	pulse_shape SiPM_11_4kV_no_trigger;
	define = &SiPM_11_4kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_11.4kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "6.3";
define->device = "SiPM-matrix";
define->fast_t_center = 28.9;
define->fast_t = PAIR(23, 30.0);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(30.4, 155);
define->long_fit_t = PAIR(30.4, 155);
define->baseline_bound = PAIR(1e-6, 1e-4);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(3e-4, 6e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;

	pulse_shape SiPM_10_6kV_no_trigger;
	define = &SiPM_10_6kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_10.6kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "5.9";
define->device = "SiPM-matrix";
define->fast_t_center = 28.9;
define->fast_t = PAIR(23, 30.3);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(30.6, 153);
define->long_fit_t = PAIR(30.6, 153);
define->baseline_bound = PAIR(1e-6, 8e-5);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(3e-4, 0.005);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;

	pulse_shape SiPM_09_7kV_no_trigger;
	define = &SiPM_09_7kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_9.7kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "5.4";
define->device = "SiPM-matrix";
define->fast_t_center = 28.9;
define->fast_t = PAIR(22, 31.4);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(31.8, 155);
define->long_fit_t = PAIR(31.8, 155);
define->baseline_bound = PAIR(1e-6, 1.5e-5);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(3e-4, 0.0013);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;

pulse_shape SiPM_08_9kV_no_trigger;
define = &SiPM_08_9kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_8.9kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.9";
define->device = "SiPM-matrix";
define->fast_t_center = 28.9;
define->fast_t = PAIR(22, 31.8);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(32.5, 54);
...
pulse_shape SiPM_08_1kV_no_trigger;
define = &SiPM_08_1kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_8.1kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.5";
define->device = "SiPM-matrix";
define->fast_t_center = 28.9;
...
pulse_shape SiPM_06_5kV_no_trigger;
define = &SiPM_06_5kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_6.5kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "3.6";
define->device = "SiPM-matrix";
define->fast_t_center = 28.9;
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(32.7, 46);
define->long_fit_t = PAIR(0, 0);
define->baseline_bound = PAIR(1e-6, 1.5e-5);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->fit_option = def_fit_option;
	...
	pulse_shape SiPM_16_3kV_no_trigger_v2;
	define = &SiPM_16_3kV_no_trigger_v2;
	copy = &SiPM_16_3kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(29.9, 40.0);
define->long_fit_t = PAIR(66, 149);
...
define->simultaneous_fit = false;
	...
	pulse_shape SiPM_14_6kV_no_trigger_v2;
	define = &SiPM_14_6kV_no_trigger_v2;
	copy = &SiPM_14_6kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(29.9, 40.0);
define->long_fit_t = PAIR(66, 149);
...
define->simultaneous_fit = false;
	...
	pulse_shape SiPM_13_0kV_no_trigger_v2;
	define = &SiPM_13_0kV_no_trigger_v2;
	copy = &SiPM_13_0kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(30.6, 40.0);
define->long_fit_t = PAIR(60, 150);
define->baseline_bound = PAIR(1e-6, 2e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-5);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(3e-4, 1.8e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;

	pulse_shape SiPM_11_4kV_no_trigger_v2;
	define = &SiPM_11_4kV_no_trigger_v2;
	copy = &SiPM_11_4kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(30.8, 40.8);
define->long_fit_t = PAIR(60, 150);
define->baseline_bound = PAIR(1e-6, 1e-3);
define->long_baseline_bound = PAIR(1e-7, 2e-5);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->simultaneous_fit = false;
	...
	pulse_shape SiPM_10_6kV_no_trigger_v2;
	define = &SiPM_10_6kV_no_trigger_v2;
	copy = &SiPM_10_6kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(31.0, 40.1);
define->long_fit_t = PAIR(56, 155);
define->baseline_bound = PAIR(1e-6, 7e-4);
define->long_baseline_bound = PAIR(1e-7, 3e-5);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->simultaneous_fit = false;
	...
	pulse_shape SiPM_09_7kV_no_trigger_v2;
	define = &SiPM_09_7kV_no_trigger_v2;
	copy = &SiPM_09_7kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(32.9, 43.0);
define->long_fit_t = PAIR(61, 155);
define->baseline_bound = PAIR(1e-6, 5e-4);
define->long_baseline_bound = PAIR(1e-7, 1e-5);
define->slow_ampl_bound = PAIR(1e-3, 0.014);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 0.002);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;

	pulse_shape SiPM_08_9kV_no_trigger_v2;
	define = &SiPM_08_9kV_no_trigger_v2;
	copy = &SiPM_08_9kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(33.2, 42.5);
define->long_fit_t = PAIR(0, 0);
...
define->simultaneous_fit = false;
	...
	pulse_shape SiPM_08_1kV_no_trigger_v2;
	define = &SiPM_08_1kV_no_trigger_v2;
	copy = &SiPM_08_1kV_no_trigger;
*define = *copy;
...
define->simultaneous_fit = false;
	...
	pulse_shape SiPM_06_5kV_no_trigger_v2;
	define = &SiPM_06_5kV_no_trigger_v2;
	copy = &SiPM_06_5kV_no_trigger;
*define = *copy;
...
define->simultaneous_fit = false;
	...
	pulse_shape PMT4_16_3kV_no_trigger;
	define = &PMT4_16_3kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_16.3kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
...
define->fit_option = def_fit_option;
	...
	pulse_shape PMT4_14_6kV_no_trigger;
	define = &PMT4_14_6kV_no_trigger;
	copy = &PMT4_16_3kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_14.6kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = copy->fnames;
define->Td = "8.1";
define->device = copy->device;
define->fast_t_center = 28.7;
define->fast_t = PAIR(23, 30.9);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(32.6, 156);
define->long_fit_t = PAIR(32.6, 156);
define->baseline_bound = PAIR(1e-6, 2e-4);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 9);
define->long_ampl_bound = PAIR(1e-4, 0.1);
define->long_tau_bound = PAIR(20, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
	...
	pulse_shape PMT4_13_0kV_no_trigger;
	define = &PMT4_13_0kV_no_trigger;
	copy = &PMT4_16_3kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_13.0kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = copy->fnames;
define->Td = "7.2";
...
define->long_ampl_bound = PAIR(1e-4, 0.009);
define->long_tau_bound = PAIR(20, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;

	pulse_shape PMT4_11_4kV_no_trigger;
	define = &PMT4_11_4kV_no_trigger;
	copy = &PMT4_16_3kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_11.4kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = copy->fnames;
define->Td = "6.3";
define->device = copy->device;
define->fast_t_center = 28.7;
define->fast_t = PAIR(23, 31.4);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(32.2, 156);
define->long_fit_t = PAIR(32.2, 156);
define->baseline_bound = PAIR(1e-6, 1e-4);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 0.1);
...
define->fit_option = def_fit_option;
	...
	pulse_shape PMT4_10_6kV_no_trigger;
	define = &PMT4_10_6kV_no_trigger;
	copy = &PMT4_16_3kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_10.6kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = copy->fnames;
define->Td = "5.9";
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.1, 156);
define->long_fit_t = PAIR(33.1, 156);
define->baseline_bound = PAIR(1e-6, 3e-5);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 0.004);
define->long_tau_bound = PAIR(20, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;

	pulse_shape PMT4_09_7kV_no_trigger;
	define = &PMT4_09_7kV_no_trigger;
	copy = &PMT4_16_3kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_9.7kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = copy->fnames;
define->Td = "5.4";
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(32.0, 45);
define->long_fit_t = PAIR(0, 0);
define->baseline_bound = PAIR(1e-6, 4e-4);
define->slow_ampl_bound = PAIR(1e-3, 1);
...
define->fit_option = def_fit_option;
	...
	pulse_shape PMT4_08_9kV_no_trigger;
	define = &PMT4_08_9kV_no_trigger;
	copy = &PMT4_16_3kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_8.9kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = copy->fnames;
define->Td = "4.9";
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(32.8, 44.5);
define->long_fit_t = PAIR(0, 0);
define->baseline_bound = PAIR(1e-6, 4e-4);
define->slow_ampl_bound = PAIR(1e-3, 1);
...
define->fit_option = def_fit_option;
	...
	pulse_shape PMT4_08_1kV_no_trigger;
	define = &PMT4_08_1kV_no_trigger;
	copy = &PMT4_16_3kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_8.1kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = copy->fnames;
define->Td = "4.5";
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.3, 48.5);
define->long_fit_t = PAIR(0, 0);
define->baseline_bound = PAIR(1e-6, 3e-4);
define->slow_ampl_bound = PAIR(1e-3, 0.004);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 0.1);
define->long_tau_bound = PAIR(20, 200);
define->simultaneous_fit = true;
...
define->fit_option = def_fit_option;
	...
	pulse_shape PMT4_06_5kV_no_trigger;
	define = &PMT4_06_5kV_no_trigger;
	copy = &PMT4_16_3kV_no_trigger;
define->folder = std::string("201217/results_v5/Pu_46V_6.5kV_850V/") + (Cd_peak ? "forms_Alpha_peak/" : "forms_Alpha_left/");
define->fnames = copy->fnames;
define->Td = "3.6";
define->device = copy->device;
define->fast_t_center = 28.6;
define->fast_t = PAIR(23, 33.1);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.1, 47);
define->long_fit_t = PAIR(0, 0);
define->baseline_bound = PAIR(1e-6, 3e-4);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->fit_option = def_fit_option;
	...
	pulse_shape PMT4_16_3kV_no_trigger_v2;
	define = &PMT4_16_3kV_no_trigger_v2;
	copy = &PMT4_16_3kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(33.6, 42.3);
define->long_fit_t = PAIR(72, 152);
define->baseline_bound = PAIR(1e-6, 3e-3);
define->long_baseline_bound = PAIR(1e-6, 2e-4);
define->slow_ampl_bound = PAIR(1e-3, 0.065);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 0.1);
define->long_tau_bound = PAIR(20, 200);
define->simultaneous_fit = false;

	pulse_shape PMT4_14_6kV_no_trigger_v2;
	define = &PMT4_14_6kV_no_trigger_v2;
	copy = &PMT4_14_6kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(34.0, 42.0);
define->long_fit_t = PAIR(74, 152);
define->baseline_bound = PAIR(1e-6, 3e-3);
define->long_baseline_bound = PAIR(1e-6, 2e-4);
define->slow_ampl_bound = PAIR(1e-3, 0.085);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 0.1);
define->long_tau_bound = PAIR(20, 200);
define->simultaneous_fit = false;

	pulse_shape PMT4_13_0kV_no_trigger_v2;
	define = &PMT4_13_0kV_no_trigger_v2;
	copy = &PMT4_13_0kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(34.5, 43.1);
define->long_fit_t = PAIR(71, 152);
define->baseline_bound = PAIR(1e-6, 1e-3);
define->long_baseline_bound = PAIR(1e-6, 2e-4);
define->slow_ampl_bound = PAIR(1e-3, 0.03);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 0.1);
define->long_tau_bound = PAIR(20, 200);
define->simultaneous_fit = false;

	pulse_shape PMT4_11_4kV_no_trigger_v2;
	define = &PMT4_11_4kV_no_trigger_v2;
	copy = &PMT4_11_4kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(34.4, 41.5);
define->long_fit_t = PAIR(55, 155);
define->baseline_bound = PAIR(1e-6, 8e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-4);
define->slow_ampl_bound = PAIR(1e-3, 0.035);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 0.1);
define->long_tau_bound = PAIR(30, 200);
define->simultaneous_fit = false;

	pulse_shape PMT4_10_6kV_no_trigger_v2;
	define = &PMT4_10_6kV_no_trigger_v2;
	copy = &PMT4_10_6kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(33.6, 40.9);
define->long_fit_t = PAIR(54, 156);
define->baseline_bound = PAIR(1e-6, 8e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-4);
define->slow_ampl_bound = PAIR(1e-3, 0.025);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 0.1);
define->long_tau_bound = PAIR(20, 200);
define->simultaneous_fit = false;

	pulse_shape PMT4_09_7kV_no_trigger_v2;
	define = &PMT4_09_7kV_no_trigger_v2;
	copy = &PMT4_09_7kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(33.6, 44.2);
define->long_fit_t = PAIR(0, 0);
define->baseline_bound = PAIR(1e-6, 2e-4);
...
pulse_shape PMT4_08_9kV_no_trigger_v2;
define = &PMT4_08_9kV_no_trigger_v2;
copy = &PMT4_08_9kV_no_trigger;
*define = *copy;
...
pulse_shape PMT4_08_1kV_no_trigger_v2;
define = &PMT4_08_1kV_no_trigger_v2;
copy = &PMT4_08_1kV_no_trigger;
*define = *copy;
...
pulse_shape PMT4_06_5kV_no_trigger_v2;
define = &PMT4_06_5kV_no_trigger_v2;
copy = &PMT4_06_5kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(33.6, 46.0);
define->long_fit_t = PAIR(0, 0);
define->baseline_bound = PAIR(1e-6, 2e-4);
...
define->simultaneous_fit = false;
	...
	std::string folder = PMTs ? std::string("201217/results_v5/PMTs/")
					: std::string("201217/results_v5/SiPMs/");
#ifdef FAST_FIGURES_MODE
	std::vector<pulse_shape> pulses;
	if (PMTs) {
		if (in_kV == "16.3")
			pulses.push_back((combined ? PMT4_16_3kV_no_trigger :  PMT4_16_3kV_no_trigger_v2));
	} else {
		if (in_kV == "16.3")
			pulses.push_back((combined ? SiPM_16_3kV_no_trigger :  SiPM_16_3kV_no_trigger_v2));
	}
#else //FAST_FIGURES_MODE
	...
	//std::vector<pulse_shape> pulses = {PMT4_16_3kV_no_trigger, PMT4_14_6kV_no_trigger, PMT4_13_0kV_no_trigger, PMT4_11_4kV_no_trigger, PMT4_10_6kV_no_trigger};
	//std::vector<pulse_shape> pulses = {PMT4_09_7kV_no_trigger, PMT4_08_9kV_no_trigger, PMT4_08_1kV_no_trigger, PMT4_06_5kV_no_trigger};
	//std::vector<pulse_shape> pulses = {PMT4_16_3kV_no_trigger_v2, PMT4_14_6kV_no_trigger_v2, PMT4_13_0kV_no_trigger_v2, PMT4_11_4kV_no_trigger_v2, PMT4_10_6kV_no_trigger_v2};
	//std::vector<pulse_shape> pulses = {PMT4_09_7kV_no_trigger_v2, PMT4_08_9kV_no_trigger_v2, PMT4_08_1kV_no_trigger_v2, PMT4_06_5kV_no_trigger_v2};
#endif //FAST_FIGURES_MODE
