...
//Same as 210909/5analysis_history.cpp
...
S2_times["210923_Pu_17.3kV_850V_46V_12dB_2300V"] = std::pair<double, double> (23, 31.5);
S2_times["210923_Pu_15.6kV_850V_46V_12dB_2300V"] = std::pair<double, double> (23, 31.5);
S2_times["210923_Pu_13.8kV_850V_46V_12dB_2300V"] = std::pair<double, double> (23, 31.5);
S2_times["210923_Pu_12.1kV_850V_46V_12dB_2300V"] = std::pair<double, double> (23, 31.5);
S2_times["210923_Pu_11.2kV_850V_46V_12dB_2300V"] = std::pair<double, double> (23, 31.7);
S2_times["210923_Pu_10.4kV_850V_46V_12dB_2300V"] = std::pair<double, double> (23, 31.7);
S2_times["210923_Pu_9.5kV_850V_46V_12dB_2300V"] = std::pair<double, double> (23, 32.1);
S2_times["210923_Pu_8.6kV_850V_46V_12dB_2300V"] = std::pair<double, double> (23, 32.5);
S2_times["210923_Pu_7.8kV_850V_46V_12dB_2300V"] = std::pair<double, double> (23, 32.5);
S2_times["210923_Pu_6.9kV_850V_46V_12dB_2300V"] = std::pair<double, double> (23, 32.5);

std::map<std::string, std::string> exp_folders;
exp_folders["210923_Pu_17.3kV_850V_46V_12dB_2300V"] = "Pu_46V_17.3kV_850V_2300V";
exp_folders["210923_Pu_15.6kV_850V_46V_12dB_2300V"] = "Pu_46V_15.6kV_850V_2300V";
exp_folders["210923_Pu_13.8kV_850V_46V_12dB_2300V"] = "Pu_46V_13.8kV_850V_2300V";
exp_folders["210923_Pu_12.1kV_850V_46V_12dB_2300V"] = "Pu_46V_12.1kV_850V_2300V";
exp_folders["210923_Pu_11.2kV_850V_46V_12dB_2300V"] = "Pu_46V_11.2kV_850V_2300V";
exp_folders["210923_Pu_10.4kV_850V_46V_12dB_2300V"] = "Pu_46V_10.4kV_850V_2300V";
exp_folders["210923_Pu_9.5kV_850V_46V_12dB_2300V"] = "Pu_46V_09.5kV_850V_2300V";
exp_folders["210923_Pu_8.6kV_850V_46V_12dB_2300V"] = "Pu_46V_08.6kV_850V_2300V";
exp_folders["210923_Pu_7.8kV_850V_46V_12dB_2300V"] = "Pu_46V_07.8kV_850V_2300V";
exp_folders["210923_Pu_6.9kV_850V_46V_12dB_2300V"] = "Pu_46V_06.9kV_850V_2300V";

std::map<std::string, double> pre_trigger_max_S; //for calibration only
pre_trigger_max_S["210923_Pu_17.3kV_850V_46V_12dB_2300V"] = 0.39;
pre_trigger_max_S["210923_Pu_15.6kV_850V_46V_12dB_2300V"] = 0.35;
pre_trigger_max_S["210923_Pu_13.8kV_850V_46V_12dB_2300V"] = 0.32;
pre_trigger_max_S["210923_Pu_12.1kV_850V_46V_12dB_2300V"] = 0.26;
pre_trigger_max_S["210923_Pu_11.2kV_850V_46V_12dB_2300V"] = 0.26;
pre_trigger_max_S["210923_Pu_10.4kV_850V_46V_12dB_2300V"] = 0.25;
pre_trigger_max_S["210923_Pu_9.5kV_850V_46V_12dB_2300V"] = 0.22;
pre_trigger_max_S["210923_Pu_8.6kV_850V_46V_12dB_2300V"] = 0.21;
pre_trigger_max_S["210923_Pu_7.8kV_850V_46V_12dB_2300V"] = 0.22;
pre_trigger_max_S["210923_Pu_6.9kV_850V_46V_12dB_2300V"] = 0.24;
...
//zcxv
if (exp == "210923_Pu_17.3kV_850V_46V_12dB_2300V") {
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_bins(500);
	x_y_regions = {312, 0, 499, 105, 717, 170, 784, 267, 999, 382};
...
if (exp == "210923_Pu_15.6kV_850V_46V_12dB_2300V") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 1000, 0, 1000);
	set_bins(500);
	x_y_regions = {259, 0, 453, 102, 624, 149, 694, 240, 999, 394};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_0-160us");
...
if (exp == "210923_Pu_13.8kV_850V_46V_12dB_2300V") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 1000, 0, 1000);
	set_bins(500);
	x_y_regions = {218, 0, 397, 95, 551, 141, 607, 214, 999, 418};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_0-160us");
...
if (exp == "210923_Pu_12.1kV_850V_46V_12dB_2300V") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_bins(800);
	x_y_regions = {182, 0, 331, 83, 425, 107, 551, 205, 799, 359};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_0-160us");
...
if (exp == "210923_Pu_11.2kV_850V_46V_12dB_2300V") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 800, 0, 800);
	set_bins(800);
	x_y_regions = {161, 0, 300, 80, 367, 94, 799, 378};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_0-160us");
...
if (exp == "210923_Pu_10.4kV_850V_46V_12dB_2300V") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 600, 0, 600);
	set_bins(600);
	x_y_regions = {160, 0, 274, 78, 353, 97, 599, 271};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_0-160us");
...
if (exp == "210923_Pu_9.5kV_850V_46V_12dB_2300V") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 600, 0, 600);
	set_bins(600);
	x_y_regions = {144, 0, 234, 64, 310, 86, 599, 304};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_0-160us");
...
if (exp == "210923_Pu_8.6kV_850V_46V_12dB_2300V") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 600, 0, 600);
	set_bins(600);
	x_y_regions = {120, 0, 226, 67, 280, 84, 599, 330};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_0-160us");
...
if (exp == "210923_Pu_7.8kV_850V_46V_12dB_2300V") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_bins(500);
	x_y_regions = {113, 0, 205, 63, 254, 78, 499, 254};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_0-160us");
...
if (exp == "210923_Pu_6.9kV_850V_46V_12dB_2300V") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 500, 0, 500);
	set_bins(500);
	x_y_regions = {113, 0, 195, 62, 256, 81, 499, 267};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_0-160us");
