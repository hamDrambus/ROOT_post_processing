...
//For 210923/results_v5, similar to 210909/compare_forms1.cpp and 211007/compare_forms1.cpp
...
//2300V on THGEM1 -> significant S3 on SiPM-matrix. Hence doing only separate fit for them
...
define->folder = std::string("210923/results_v5/Pu_46V_17.3kV_850V_2300V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_edge_form_by_Npe.hdata"};
define->Td = "8.9";
define->device = "SiPM-matrix, 2300V";
define->fast_t_center = 28.7;
define->fast_t = PAIR(23.0, 30.3);
...
define->folder = std::string("210923/results_v5/Pu_46V_15.6kV_850V_2300V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_edge_form_by_Npe.hdata"};
define->Td = "8.0";
define->device = "SiPM-matrix, 2300V";
define->fast_t_center = 28.8;
define->fast_t = PAIR(23.0, 30.5);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.2, 48);
define->long_fit_t = PAIR(86, 154);
define->baseline_bound = PAIR(1e-6, 1.3e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(3e-2, 3e-1);
...
define->folder = std::string("210923/results_v5/Pu_46V_13.8kV_850V_2300V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_edge_form_by_Npe.hdata"};
define->Td = "7.1";
define->device = "SiPM-matrix, 2300V";
define->fast_t_center = 28.9;
define->fast_t = PAIR(23.0, 30.7);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.7, 47);
define->long_fit_t = PAIR(86, 154);
define->baseline_bound = PAIR(1e-6, 1.3e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
...
define->folder = std::string("210923/results_v5/Pu_46V_12.1kV_850V_2300V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_edge_form_by_Npe.hdata"};
define->Td = "6.3";
define->device = "SiPM-matrix, 2300V";
define->fast_t_center = 29.0;
define->fast_t = PAIR(23.0, 31.1);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(34.1, 47);
define->long_fit_t = PAIR(86, 154);
...
define->folder = std::string("210923/results_v5/Pu_46V_11.2kV_850V_2300V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_edge_form_by_Npe.hdata"};
define->Td = "5.8";
define->device = "SiPM-matrix, 2300V";
define->fast_t_center = 29.1;
define->fast_t = PAIR(23.0, 31.4);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(34.5, 46.5);
...
define->folder = std::string("210923/results_v5/Pu_46V_10.4kV_850V_2300V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_edge_form_by_Npe.hdata"};
define->Td = "5.4";
define->device = "SiPM-matrix, 2300V";
define->fast_t_center = 29.2;
define->fast_t = PAIR(23.0, 31.3);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(34.7, 46.0);
define->long_fit_t = PAIR(87, 154);
define->baseline_bound = PAIR(1e-6, 1.3e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-2, 1e-1);
...
define->folder = std::string("210923/results_v5/Pu_46V_09.5kV_850V_2300V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_edge_form_by_Npe.hdata"};
define->Td = "5.0";
define->device = "SiPM-matrix, 2300V";
define->fast_t_center = 29.2;
define->fast_t = PAIR(23.0, 31.8);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(35.1, 47.0);
...
define->folder = std::string("210923/results_v5/Pu_46V_08.6kV_850V_2300V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_edge_form_by_Npe.hdata"};
define->Td = "4.5";
define->device = "SiPM-matrix, 2300V";
...
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-2, 7e-1);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->folder = std::string("210923/results_v5/Pu_46V_07.8kV_850V_2300V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_edge_form_by_Npe.hdata"};
define->Td = "4.1";
define->device = "SiPM-matrix, 2300V";
define->fast_t_center = 29.3;
...
define->folder = std::string("210923/results_v5/Pu_46V_06.9kV_850V_2300V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_edge_form_by_Npe.hdata"};
define->Td = "3.6";
define->device = "SiPM-matrix, 2300V";
define->fast_t_center = 29.3;
...
define->fast_t = PAIR(24.0, 30.1);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(32.3, 155);
define->long_fit_t = PAIR(32.3, 155);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(3e-2, 2e-1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(2e-3, 3e-2);
define->long_tau_bound = PAIR(15, 200);
...
*define = *copy;
define->slow_fit_t = PAIR(33.8, 42.5);
define->long_fit_t = PAIR(82, 155);
define->baseline_bound = PAIR(1e-6, 4.2e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-2, 2e-1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(2e-3, 3e-2);
...
*define = *copy;
define->slow_fit_t = PAIR(33.4, 42.4);
define->long_fit_t = PAIR(84, 155);
...
*define = *copy;
define->slow_fit_t = PAIR(33.7, 42.7);
define->long_fit_t = PAIR(82, 155);
define->baseline_bound = PAIR(1e-6, 4.2e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(3e-2, 1e-1);
...
*define = *copy;
define->slow_fit_t = PAIR(33.9, 42.0);
define->long_fit_t = PAIR(84, 155);
...
*define = *copy;
define->slow_fit_t = PAIR(33.9, 40.8);
define->long_fit_t = PAIR(84, 155);
define->baseline_bound = PAIR(1e-6, 3e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-2, 1e-1);
...
*define = *copy;
define->slow_fit_t = PAIR(33.5, 43.2);
define->long_fit_t = PAIR(84, 155);
...
*define = *copy;
define->slow_fit_t = PAIR(34.0, 43.0);
define->long_fit_t = PAIR(84, 155);
...
*define = *copy;
define->slow_fit_t = PAIR(33.3, 43.5);
...
define->simultaneous_fit = false;
	...
	std::string folder = PMTs ? std::string("210923/results_v5/PMTs_v1/")
					: std::string("210923/results_v5/SiPMs_v1/");
	...
	if (print_results) {
		if (!linear) {
			...
			if (print_errors) {
				...
				add_text(76, 0.007, Slow_title, frsS, palette_major);
				add_text(100, 0.007, Long_title, frsL, palette_major);
				add_text(129, 0.007, no_title, tau2, palette_major);
			} else {
