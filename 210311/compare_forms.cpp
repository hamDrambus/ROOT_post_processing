...
int compare_forms (void) {
	...
	double time_pretrigger_left = 5.5, time_pretrigger_right = 26.0;
...
define->fit_option = def_fit_option;
	...
	//std::vector<pulse_shape> pulses = {SiPM_7_6kV_131K_no_trigger, SiPM_7_6kV_200K_no_trigger};
	std::vector<pulse_shape> pulses = {PMT4_7_6kV_131K_no_trigger, PMT4_7_6kV_200K_no_trigger};
