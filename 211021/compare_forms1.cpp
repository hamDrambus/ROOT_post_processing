...
//For 211021/results_v5, same as 210909/compare_forms1.cpp
//10.7 mm with 238Pu set on the cathode. (Mesh instead of THGEM0, 28% CERN #8 as THEGEM1, PMT#1 malfunctions due to mixed signal wires)
//0.75 atm pressure (84.67 K)
...
define->folder = std::string("211021/results_v5/Pu_46V_13.0kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "8.3";
define->device = "SiPM-matrix";
define->fast_t_center = 28.3;
define->fast_t = PAIR(23.5, 30.2);
...
define->long_ampl_bound = PAIR(8e-4, 2e-2);
...
*define = *copy;
define->slow_fit_t = PAIR(32.8, 41.0);
define->long_fit_t = PAIR(81, 154);
...
define->folder = std::string("211021/results_v5/Pu_46V_11.7kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "7.5";
define->device = "SiPM-matrix";
define->fast_t_center = 28.4;
define->fast_t = PAIR(23.5, 30.3);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(31.7, 154);
define->long_fit_t = PAIR(31.7, 154);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-2, 1e-1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(8e-4, 2e-2);
...
*define = *copy;
define->slow_fit_t = PAIR(32.5, 41.0);
define->long_fit_t = PAIR(79, 154);
define->baseline_bound = PAIR(1e-6, 2e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-2, 1e-1);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->folder = std::string("211021/results_v5/Pu_46V_10.4kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "6.6";
define->device = "SiPM-matrix";
define->fast_t_center = 28.4;
define->fast_t = PAIR(23.5, 30.6);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
*define = *copy;
define->slow_fit_t = PAIR(33.4, 40.4);
...
define->simultaneous_fit = false;
  ...
  pulse_shape SiPM_08_4kV_no_trigger;
  define = &SiPM_08_4kV_no_trigger;
define->folder = std::string("211021/results_v5/Pu_46V_08.4kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "5.4";
define->device = "SiPM-matrix";
define->fast_t_center = 28.5;
define->fast_t = PAIR(23.5, 31.4);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->long_fit_t = PAIR(32.4, 154);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(8e-3, 3e-2);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_08_4kV_no_trigger_v2;
  define = &SiPM_08_4kV_no_trigger_v2;
  copy = &SiPM_08_4kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(33.6, 40.4);
define->long_fit_t = PAIR(79, 154);
...
define->folder = std::string("211021/results_v5/");
define->fnames = {std::string("Pu_46V_07.8kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/") + "SiPMs_form_by_Npe.hdata",
std::string("Pu_46V_07.8kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/") + "SiPMs_form_by_Npe.hdata"};
define->Td = "5.0";
define->device = "SiPM-matrix";
define->fast_t_center = 28.5;
...
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(5e-3, 2e-2);
define->slow_tau_bound = PAIR(2.5, 10);
...
*define = *copy;
define->slow_fit_t = PAIR(33.7, 41.8);
...
define->simultaneous_fit = false;
  ...
  pulse_shape SiPM_07_1kV_no_trigger;
  define = &SiPM_07_1kV_no_trigger;
define->folder = std::string("211021/results_v5/Pu_46V_07.1kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.5";
define->device = "SiPM-matrix";
define->fast_t_center = 28.5;
define->fast_t = PAIR(23.5, 31.9);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_07_1kV_no_trigger_v2;
  define = &SiPM_07_1kV_no_trigger_v2;
  copy = &SiPM_07_1kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(34.2, 47.2);
define->long_fit_t = PAIR(72, 154);
...
define->simultaneous_fit = false;
  ...
  pulse_shape SiPM_05_8kV_no_trigger;
  define = &SiPM_05_8kV_no_trigger;
define->folder = std::string("211021/results_v5/Pu_46V_05.8kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "3.7";
define->device = "SiPM-matrix";
define->fast_t_center = 28.4;
define->fast_t = PAIR(23.5, 32.3);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->long_fit_t = PAIR(33.2, 154);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(6e-3, 1.5e-2);
define->slow_tau_bound = PAIR(2.5, 14);
define->long_ampl_bound = PAIR(3e-5, 4e-4);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;

  pulse_shape SiPM_05_8kV_no_trigger_v2;
  define = &SiPM_05_8kV_no_trigger_v2;
  copy = &SiPM_05_8kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(36.2, 55);
...
define->simultaneous_fit = false;
  ...
  pulse_shape SiPM_05_2kV_no_trigger;
  define = &SiPM_05_2kV_no_trigger;
define->folder = std::string("211021/results_v5/Pu_46V_05.2kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "3.3";
define->device = "SiPM-matrix";
define->fast_t_center = 28.3;
define->fast_t = PAIR(22.5, 32.2);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.1, 154);
define->long_fit_t = PAIR(33.1, 154);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(7e-3, 3e-2);
define->slow_tau_bound = PAIR(2.5, 15);
define->long_ampl_bound = PAIR(1e-5, 2e-4);
define->long_tau_bound = PAIR(20, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;

  pulse_shape SiPM_05_2kV_no_trigger_v2;
  define = &SiPM_05_2kV_no_trigger_v2;
  copy = &SiPM_05_2kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(36.8, 60);
...
define->slow_ampl_bound = PAIR(2e-2, 1e-1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-3, 1.5e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(33.3, 39.3);
define->long_fit_t = PAIR(76, 155);
...
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(9e-4, 1e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(33.3, 40.8);
define->long_fit_t = PAIR(79, 155);
define->baseline_bound = PAIR(1e-6, 3.1e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-2, 8e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(9e-4, 1e-2);
...
*define = *copy;
define->slow_fit_t = PAIR(33.8, 40.2);
...
define->simultaneous_fit = false;
  ...
  pulse_shape PMT4_08_4kV_no_trigger;
  define = &PMT4_08_4kV_no_trigger;
define->folder = std::string("211021/results_v5/Pu_46V_08.4kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
if(PMT_used&0x1) define->fnames.push_back(fast_PMTs ? "5_form_by_Npe.hdata" : "1_form_by_Npe.hdata");
if(PMT_used&0x2) define->fnames.push_back(fast_PMTs ? "6_form_by_Npe.hdata" : "2_form_by_Npe.hdata");
if(PMT_used&0x4) define->fnames.push_back(fast_PMTs ? "7_form_by_Npe.hdata" : "3_form_by_Npe.hdata");
...
define->fit_option = def_fit_option;
  ...
  pulse_shape PMT4_08_4kV_no_trigger_v2;
  define = &PMT4_08_4kV_no_trigger_v2;
  copy = &PMT4_08_4kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(33.7, 40.0);
define->long_fit_t = PAIR(77, 155);
...
define->folder = std::string("Pu_46V_07.8kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
if(PMT_used&0x1) define->fnames.push_back(define->folder + (fast_PMTs ? "5_form_by_Npe.hdata" : "1_form_by_Npe.hdata"));
if(PMT_used&0x2) define->fnames.push_back(define->folder + (fast_PMTs ? "6_form_by_Npe.hdata" : "2_form_by_Npe.hdata"));
if(PMT_used&0x4) define->fnames.push_back(define->folder + (fast_PMTs ? "7_form_by_Npe.hdata" : "3_form_by_Npe.hdata"));
if(PMT_used&0x8) define->fnames.push_back(define->folder + (fast_PMTs ? "8_form_by_Npe.hdata" : "4_form_by_Npe.hdata"));
define->folder = std::string("Pu_46V_07.8kV_850V_1/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
if(PMT_used&0x1) define->fnames.push_back(define->folder + (fast_PMTs ? "5_form_by_Npe.hdata" : "1_form_by_Npe.hdata"));
if(PMT_used&0x2) define->fnames.push_back(define->folder + (fast_PMTs ? "6_form_by_Npe.hdata" : "2_form_by_Npe.hdata"));
if(PMT_used&0x4) define->fnames.push_back(define->folder + (fast_PMTs ? "7_form_by_Npe.hdata" : "3_form_by_Npe.hdata"));
if(PMT_used&0x8) define->fnames.push_back(define->folder + (fast_PMTs ? "8_form_by_Npe.hdata" : "4_form_by_Npe.hdata"));
...
define->long_fit_t = PAIR(75, 155);
define->baseline_bound = PAIR(1e-6, 7.4e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-3, 1.5e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(2e-4, 3e-3);
...
define->simultaneous_fit = false;
  ...
  pulse_shape PMT4_07_1kV_no_trigger;
  define = &PMT4_07_1kV_no_trigger;
define->folder = std::string("211021/results_v5/Pu_46V_07.1kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
if(PMT_used&0x1) define->fnames.push_back(fast_PMTs ? "5_form_by_Npe.hdata" : "1_form_by_Npe.hdata");
if(PMT_used&0x2) define->fnames.push_back(fast_PMTs ? "6_form_by_Npe.hdata" : "2_form_by_Npe.hdata");
if(PMT_used&0x4) define->fnames.push_back(fast_PMTs ? "7_form_by_Npe.hdata" : "3_form_by_Npe.hdata");
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.1, 155);
define->long_fit_t = PAIR(33.1, 155);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-3, 1e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(3e-4, 2e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;

  pulse_shape PMT4_07_1kV_no_trigger_v2;
  define = &PMT4_07_1kV_no_trigger_v2;
  copy = &PMT4_07_1kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(34.5, 48.0);
...
define->simultaneous_fit = false;
  ...
  pulse_shape PMT4_05_8kV_no_trigger;
  define = &PMT4_05_8kV_no_trigger;
define->folder = std::string("211021/results_v5/Pu_46V_05.8kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
if(PMT_used&0x1) define->fnames.push_back(fast_PMTs ? "5_form_by_Npe.hdata" : "1_form_by_Npe.hdata");
if(PMT_used&0x2) define->fnames.push_back(fast_PMTs ? "6_form_by_Npe.hdata" : "2_form_by_Npe.hdata");
if(PMT_used&0x4) define->fnames.push_back(fast_PMTs ? "7_form_by_Npe.hdata" : "3_form_by_Npe.hdata");
...
define->slow_ampl_bound = PAIR(4e-3, 1.5e-2);
define->slow_tau_bound = PAIR(2.5, 15);
define->long_ampl_bound = PAIR(1e-4, 1.5e-3);
define->long_tau_bound = PAIR(17, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;

  pulse_shape PMT4_05_8kV_no_trigger_v2;
  define = &PMT4_05_8kV_no_trigger_v2;
  copy = &PMT4_05_8kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(36.7, 56.5);
define->long_fit_t = PAIR(75, 155);
define->baseline_bound = PAIR(1e-6, 4e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(4e-4, 1.5e-2);
define->slow_tau_bound = PAIR(2.5, 15);
define->long_ampl_bound = PAIR(1e-4, 1.5e-3);
define->long_tau_bound = PAIR(17, 200);
define->simultaneous_fit = false;

  pulse_shape PMT4_05_2kV_no_trigger;
  define = &PMT4_05_2kV_no_trigger;
define->folder = std::string("211021/results_v5/Pu_46V_05.2kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
if(PMT_used&0x1) define->fnames.push_back(fast_PMTs ? "5_form_by_Npe.hdata" : "1_form_by_Npe.hdata");
if(PMT_used&0x2) define->fnames.push_back(fast_PMTs ? "6_form_by_Npe.hdata" : "2_form_by_Npe.hdata");
if(PMT_used&0x4) define->fnames.push_back(fast_PMTs ? "7_form_by_Npe.hdata" : "3_form_by_Npe.hdata");
...
define->fast_t = PAIR(24.0, 32.7);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.6, 155);
define->long_fit_t = PAIR(33.6, 155);
define->baseline_bound = PAIR(1e-6, 1e-6);
...
define->fit_option = def_fit_option;
  ...
  pulse_shape PMT4_05_2kV_no_trigger_v2;
  define = &PMT4_05_2kV_no_trigger_v2;
  copy = &PMT4_05_2kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(36.0, 57.0);
define->long_fit_t = PAIR(78, 155);
define->baseline_bound = PAIR(1e-6, 6.5e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(3e-3, 2e-2);
define->slow_tau_bound = PAIR(2.5, 15);
define->long_ampl_bound = PAIR(2e-4, 3e-3);
...
define->simultaneous_fit = false;
	...
	std::string folder = PMTs ? std::string("211021/results_v5/PMTs_v1/")
					: std::string("211021/results_v5/SiPMs_v1/");
	//std::vector<pulse_shape> pulses = {SiPM_13_0kV_no_trigger, SiPM_11_7kV_no_trigger, SiPM_10_4kV_no_trigger, SiPM_08_4kV_no_trigger};
	//std::vector<pulse_shape> pulses = {SiPM_07_8kV_no_trigger, SiPM_07_1kV_no_trigger, SiPM_05_8kV_no_trigger, SiPM_05_2kV_no_trigger};
	//std::vector<pulse_shape> pulses = {SiPM_13_0kV_no_trigger_v2, SiPM_11_7kV_no_trigger_v2, SiPM_10_4kV_no_trigger_v2, SiPM_08_4kV_no_trigger_v2};
	//std::vector<pulse_shape> pulses = {SiPM_07_8kV_no_trigger_v2, SiPM_07_1kV_no_trigger_v2, SiPM_05_8kV_no_trigger_v2, SiPM_05_2kV_no_trigger_v2};

	//std::vector<pulse_shape> pulses = {PMT4_13_0kV_no_trigger, PMT4_11_7kV_no_trigger, PMT4_10_4kV_no_trigger, PMT4_08_4kV_no_trigger};
	//std::vector<pulse_shape> pulses = {PMT4_07_8kV_no_trigger, PMT4_07_1kV_no_trigger, PMT4_05_8kV_no_trigger, PMT4_05_2kV_no_trigger};
  //std::vector<pulse_shape> pulses = {PMT4_13_0kV_no_trigger_v2, PMT4_11_7kV_no_trigger_v2, PMT4_10_4kV_no_trigger_v2, PMT4_08_4kV_no_trigger_v2};
	std::vector<pulse_shape> pulses = {PMT4_07_8kV_no_trigger_v2, PMT4_07_1kV_no_trigger_v2, PMT4_05_8kV_no_trigger_v2, PMT4_05_2kV_no_trigger_v2};

	//std::vector<pulse_shape> pulses = {PMT4_05_2kV_no_trigger};
	...
	if (PMTs)
		framename = std::string("Results for 3PMT (no WLS), 0.75 atm., ")+(Cd_peak ? "" : "< ")+"5.6 MeV #alpha ^{238}Pu";
	else
		framename = std::string("Results for SiPM-matrix (no WLS), 0.75 atm., ")+(Cd_peak ? "" : "< ")+"5.6 MeV #alpha ^{238}Pu";
