...
pulse_shape SiPM_10_4kV_85K_peak;
define = &SiPM_10_4kV_85K_peak;
	define->folder = std::string("211021/results_v5/Pu_46V_10.4kV_850V/forms_Pu_peak/");
	define->fnames = {"SiPMs_form_by_Npe.hdata"};
	define->Td = "6.5";
	define->device = "SiPM-matrix, 84.7K, Pu peak";
	define->baseline_t = avg_baseline ? PAIR(4.6, 20) : (min_baseline ? PAIR(0, 0) : PAIR(0, 0));
	define->fast_t_center = 28.4;
	define->fast_t = PAIR(23.5, 66.2);
	define->S1_t_center = 0;
	define->S1_t = PAIR(0, 0);
	define->scale = 1;
	define->subtract_baseline = subtact_baseline;
	define->renormalize = true;
	define->long_fit_t = PAIR(61.1, 153);
...
pulse_shape SiPM_10_4kV_85K_slope;
define = &SiPM_10_4kV_85K_slope;
copy = &SiPM_10_4kV_85K_peak;
	define->folder = std::string("211021/results_v5/Pu_46V_10.4kV_850V/forms_Pu_left/");
	define->fnames = {"SiPMs_form_by_Npe.hdata"};
	define->Td = "6.5";
	define->device = "SiPM-matrix, 84.7K, Pu slope";
	define->baseline_t = avg_baseline ? PAIR(4.6, 20) : (min_baseline ? PAIR(0, 0) : PAIR(0, 0));
...
pulse_shape PMT4_10_4kV_85K_peak;
define = &PMT4_10_4kV_85K_peak;
	define->folder = std::string("211021/results_v5/Pu_46V_10.4kV_850V/forms_Pu_peak/");
	...
	define->device += ", 84.7K, Pu peak";
	define->baseline_t = avg_baseline ? PAIR(4.6, 20) : (min_baseline ? PAIR(0, 0) : PAIR(0, 0));
	define->fast_t_center = 28.3;
	define->fast_t = PAIR(24.5, 66.1);
	define->S1_t_center = 0;
	define->S1_t = PAIR(0, 0);
	define->scale = 1;
	define->subtract_baseline = subtact_baseline;
	define->renormalize = true;
	define->long_fit_t = PAIR(62.1, 155);
	define->baseline_bound = PAIR(1e-6, 1e-6);
...
pulse_shape PMT4_10_4kV_85K_slope;
define = &PMT4_10_4kV_85K_slope;
copy = &PMT4_10_4kV_85K_peak;
	define->folder = std::string("211021/results_v5/Pu_46V_10.4kV_850V/forms_Pu_left/");
...
pulse_shape SiPM_11_7kV_85K_peak;
define = &SiPM_11_7kV_85K_peak;
	define->folder = std::string("211021/results_v5/Pu_46V_11.7kV_850V/forms_Pu_peak/");
	define->fnames = {"SiPMs_form_by_Npe.hdata"};
	define->Td = "7.3";
	define->device = "SiPM-matrix, 84.7K, Pu peak";
	define->baseline_t = avg_baseline ? PAIR(4.6, 20) : (min_baseline ? PAIR(0, 0) : PAIR(0, 0));
...
pulse_shape SiPM_11_7kV_85K_slope;
define = &SiPM_11_7kV_85K_slope;
copy = &SiPM_11_7kV_85K_peak;
	define->folder = std::string("211021/results_v5/Pu_46V_11.7kV_850V/forms_Pu_left/");
	define->fnames = {"SiPMs_form_by_Npe.hdata"};
	define->device = "SiPM-matrix, 84.7K, Pu slope";
	define->baseline_t = avg_baseline ? PAIR(4.6, 20) : (min_baseline ? PAIR(0, 0) : PAIR(0, 0));
	define->Td = copy->Td;
...
pulse_shape PMT4_11_7kV_85K_peak;
define = &PMT4_11_7kV_85K_peak;
	define->folder = std::string("211021/results_v5/Pu_46V_11.7kV_850V/forms_Pu_peak/");
	if(PMT_used&0x1) define->fnames.push_back(fast_PMTs ? "5_form_by_Npe.hdata" : "1_form_by_Npe.hdata");
	if(PMT_used&0x2) define->fnames.push_back(fast_PMTs ? "6_form_by_Npe.hdata" : "2_form_by_Npe.hdata");
	if(PMT_used&0x4) define->fnames.push_back(fast_PMTs ? "7_form_by_Npe.hdata" : "3_form_by_Npe.hdata");
...
pulse_shape PMT4_11_7kV_85K_slope;
define = &PMT4_11_7kV_85K_slope;
copy = &PMT4_11_7kV_85K_peak;
	define->folder = std::string("211021/results_v5/Pu_46V_11.7kV_850V/forms_Pu_left/");
	define->fnames = copy->fnames;
	if(PMT_used == (0x1|0x2|0x4|0x8))
		define->device = "4PMT ";
