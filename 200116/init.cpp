{
  ...
  data_prefix_path = "../Data/200116/results_v1/";
  ...
  exp_area.experiments.push_back("200116_Pu_20kV_850V_46V_12dB");
  ...
  experiment_fields["200116_Pu_20kV_850V_46V_12dB"] = 20;

  std::map<std::string, int> experiment_runs; //required for printing accpeted/rejected events
  experiment_runs["200116_Pu_20kV_850V_46V_12dB"] = 15;
