...
//For 211202/results_v5, same as 210909/compare_forms1.cpp
//18.0, 15.9 and 9.6 mm with 238Pu set on the cathode.
//(Mesh instead of THGEM0, 28% CERN #8 as THEGEM1, 75% THGEM + cold finger as SiPM grouding mesh)
//1 atm pressure (87 K)
...
define->slow_ampl_bound = PAIR(3e-2, 1.1e-1);
...
*define = *copy;
define->slow_fit_t = PAIR(33.4, 40.5);
...
*define = *copy;
define->slow_fit_t = PAIR(33.0, 40.8);
...
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-2, 7e-2);
define->slow_tau_bound = PAIR(2.5, 10);
...
*define = *copy;
define->slow_fit_t = PAIR(32.8, 40.9);
define->long_fit_t = PAIR(78, 154);
define->baseline_bound = PAIR(1e-6, 2.0e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-2, 7e-2);
...
*define = *copy;
define->slow_fit_t = PAIR(32.7, 41.5);
define->long_fit_t = PAIR(76, 154);
...
*define = *copy;
define->slow_fit_t = PAIR(32.4, 41.4);
define->long_fit_t = PAIR(69, 154);
...
*define = *copy;
define->slow_fit_t = PAIR(32.8, 40.6);
...
*define = *copy;
define->slow_fit_t = PAIR(33.0, 40.3);
define->long_fit_t = PAIR(63, 154);
define->baseline_bound = PAIR(1e-6, 9e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(4e-3, 1.5e-2);
...
*define = *copy;
define->slow_fit_t = PAIR(33.0, 40.0);
define->long_fit_t = PAIR(63, 154);
define->baseline_bound = PAIR(1e-6, 1.1e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(3e-3, 1e-2);
...
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(6e-4, 3e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(33.1, 48.0);
...
define->folder = std::string("211202/results_v5/Pu_16mm_46V_16kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "7.1";
define->device = "SiPM-matrix";
define->fast_t_center = 28.8;
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(31.0, 154);
define->long_fit_t = PAIR(31.0, 154);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(3e-2, 1.1e-1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-3, 2e-2);
...
*define = *copy;
define->slow_fit_t = PAIR(32.3, 41.3);
...
define->simultaneous_fit = false;
  ...
  pulse_shape SiPM_15kV_no_trigger;
  define = &SiPM_15kV_no_trigger;
define->folder = std::string("211202/results_v5/Pu_16mm_46V_15kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "6.7";
define->device = "SiPM-matrix";
define->fast_t_center = 28.8;
...
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-2, 9e-2);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_15kV_no_trigger_v2;
  define = &SiPM_15kV_no_trigger_v2;
  copy = &SiPM_15kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(32.0, 40.2);
define->long_fit_t = PAIR(78, 154);
...
define->folder = std::string("211202/results_v5/Pu_18mm_46V_14kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "6.0";
define->device = "SiPM-matrix";
define->fast_t_center = 29.6;
define->fast_t = PAIR(25.5, 32.2);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
*define = *copy;
define->slow_fit_t = PAIR(33.3, 41.9);
define->long_fit_t = PAIR(78, 154);
...
define->folder = std::string("211202/results_v5/Pu_18mm_46V_13kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "5.6";
define->device = "SiPM-matrix";
define->fast_t_center = 29.8;
define->fast_t = PAIR(25.5, 32.8);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->folder = std::string("211202/results_v5/Pu_18mm_46V_12kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "5.2";
define->device = "SiPM-matrix";
define->fast_t_center = 29.8;
...
define->folder = std::string("211202/results_v5/Pu_18mm_46V_11kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.7";
define->device = "SiPM-matrix";
define->fast_t_center = 30.0;
define->fast_t = PAIR(24.5, 33.4);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.4, 154);
define->long_fit_t = PAIR(33.4, 154);
define->baseline_bound = PAIR(1e-6, 1e-6);
...
*define = *copy;
define->slow_fit_t = PAIR(33.8, 39.5);
...
define->folder = std::string("211202/results_v5/Pu_18mm_46V_10kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.3";
define->device = "SiPM-matrix";
define->fast_t_center = 30.3;
define->fast_t = PAIR(24.5, 34.0);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(34.2, 154);
define->long_fit_t = PAIR(34.2, 154);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 1.3e-2);
define->slow_tau_bound = PAIR(2, 9);
...
*define = *copy;
define->slow_fit_t = PAIR(34.1, 37.0);
define->long_fit_t = PAIR(53, 154);
...
define->folder = std::string("211202/results_v5/Pu_18mm_46V_09kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "3.9";
define->device = "SiPM-matrix";
define->fast_t_center = 30.1;
define->fast_t = PAIR(23.5, 33.8);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.8, 154);
define->long_fit_t = PAIR(33.8, 154);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(5e-4, 1.2e-2);
define->slow_tau_bound = PAIR(2, 9);
define->long_ampl_bound = PAIR(3e-4, 1.5e-2);
define->long_tau_bound = PAIR(10, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(33.8, 36.5);
define->long_fit_t = PAIR(53, 154);
...
define->simultaneous_fit = false;
  ...
  pulse_shape SiPM_08kV_no_trigger;
  define = &SiPM_08kV_no_trigger;
define->folder = std::string("211202/results_v5/Pu_18mm_46V_08kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "3.5";
define->device = "SiPM-matrix";
define->fast_t_center = 29.9;
define->fast_t = PAIR(23.0, 33.8);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->long_fit_t = PAIR(33.8, 154);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(5e-4, 1.4e-2);
define->slow_tau_bound = PAIR(2, 9);
define->long_ampl_bound = PAIR(3e-4, 1.5e-2);
define->long_tau_bound = PAIR(10, 200);
define->simultaneous_fit = true;
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_08kV_no_trigger_v2;
  define = &SiPM_08kV_no_trigger_v2;
...
*define = *copy;
define->slow_fit_t = PAIR(33.3, 40.7);
define->long_fit_t = PAIR(80, 155);
...
*define = *copy;
define->slow_fit_t = PAIR(33.7, 41.2);
...
*define = *copy;
define->slow_fit_t = PAIR(34.3, 41.1);
...
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(4e-3, 1.6e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(2e-4, 3e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(32.0, 155);
define->long_fit_t = PAIR(32.0, 155);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(3e-3, 1.6e-2);
define->slow_tau_bound = PAIR(1.5, 10);
define->long_ampl_bound = PAIR(2e-4, 3e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
...
*define = *copy;
define->slow_fit_t = PAIR(33.6, 39.8);
define->long_fit_t = PAIR(62, 155);
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(32.1, 155);
define->long_fit_t = PAIR(32.1, 155);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-3, 8e-3);
define->slow_tau_bound = PAIR(1.5, 10);
define->long_ampl_bound = PAIR(2e-4, 3e-3);
...
*define = *copy;
define->slow_fit_t = PAIR(32.5, 37.6);
define->long_fit_t = PAIR(62, 155);
define->baseline_bound = PAIR(1e-6, 6e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-3, 8e-3);
...
*define = *copy;
define->slow_fit_t = PAIR(32.4, 37.5);
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(31.9, 155);
define->long_fit_t = PAIR(31.9, 155);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 5e-3);
define->slow_tau_bound = PAIR(1.0, 10);
define->long_ampl_bound = PAIR(2e-4, 3e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
...
*define = *copy;
define->slow_fit_t = PAIR(31.9, 34.7);
...
define->slow_ampl_bound = PAIR(1.5e-2, 6e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(8e-4, 6e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(33.9, 41.3);
...
define->simultaneous_fit = false;
  ...
  pulse_shape PMT4_15kV_no_trigger;
  define = &PMT4_15kV_no_trigger;
define->folder = std::string("211202/results_v5/Pu_16mm_46V_15kV_850V/") + (Cd_peak ? "forms_Pu_peak/" : "forms_Pu_left/");
if(PMT_used&0x1) define->fnames.push_back(fast_PMTs ? "5_form_by_Npe.hdata" : "1_form_by_Npe.hdata");
if(PMT_used&0x2) define->fnames.push_back(fast_PMTs ? "6_form_by_Npe.hdata" : "2_form_by_Npe.hdata");
if(PMT_used&0x4) define->fnames.push_back(fast_PMTs ? "7_form_by_Npe.hdata" : "3_form_by_Npe.hdata");
...
define->fit_option = def_fit_option;
  ...
  pulse_shape PMT4_15kV_no_trigger_v2;
  define = &PMT4_15kV_no_trigger_v2;
  copy = &PMT4_15kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(33.9, 41.3);
define->long_fit_t = PAIR(79, 155);
define->baseline_bound = PAIR(1e-6, 1.1e-3);
...
*define = *copy;
define->slow_fit_t = PAIR(33.9, 40.6);
define->long_fit_t = PAIR(78, 155);
define->baseline_bound = PAIR(1e-6, 7e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(5e-3, 2e-2);
...
*define = *copy;
define->slow_fit_t = PAIR(33.5, 40.6);
define->long_fit_t = PAIR(58, 155);
define->baseline_bound = PAIR(1e-6, 5e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(3e-3, 1.5e-2);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->long_ampl_bound = PAIR(3e-4, 8e-3);
define->long_tau_bound = PAIR(10, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(33.4, 38.1);
define->long_fit_t = PAIR(53, 155);
define->baseline_bound = PAIR(1e-6, 5e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(3e-3, 1.5e-2);
define->slow_tau_bound = PAIR(2.5, 9);
...
define->slow_tau_bound = PAIR(2.5, 9);
define->long_ampl_bound = PAIR(4e-4, 9e-3);
define->long_tau_bound = PAIR(10, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(33.9, 38.2);
define->long_fit_t = PAIR(53, 155);
...
define->long_fit_t = PAIR(33.9, 155);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-4, 1.1e-2);
define->slow_tau_bound = PAIR(2.5, 9);
define->long_ampl_bound = PAIR(4e-4, 1.1e-2);
define->long_tau_bound = PAIR(10, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(33.9, 38.0);
define->long_fit_t = PAIR(53, 155);
define->baseline_bound = PAIR(1e-6, 5e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-4, 1.1e-2);
...
define->simultaneous_fit = false;
  ...
  pulse_shape PMT4_08kV_no_trigger;
...
if (!fast_PMTs) define->device += " (slow)";
define->fast_t_center = 30.0;
define->fast_t = PAIR(23.0, 34.0);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(34.0, 155);
define->long_fit_t = PAIR(34.0, 155);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-4, 1e-2);
define->slow_tau_bound = PAIR(2.5, 9);
define->long_ampl_bound = PAIR(7e-4, 1.1e-2);
define->long_tau_bound = PAIR(10, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;

  pulse_shape PMT4_08kV_no_trigger_v2;
  define = &PMT4_08kV_no_trigger_v2;
  copy = &PMT4_08kV_no_trigger;
*define = *copy;
define->slow_fit_t = PAIR(34.0, 38.0);
define->long_fit_t = PAIR(53, 155);
...
std::string folder = PMTs ? std::string("211202/results_v5/v1_PMTs/")
					: std::string("211202/results_v5/v1_SiPMs/");
	...
	//std::vector<pulse_shape> pulses = {SiPM_10_4kV_no_trigger, SiPM_09_5kV_no_trigger, SiPM_08_6kV_no_trigger, SiPM_07_8kV_no_trigger};
  //std::vector<pulse_shape> pulses = {SiPM_17_3kV_no_trigger_v2, SiPM_15_6kV_no_trigger_v2, SiPM_13_8kV_no_trigger_v2, SiPM_12_1kV_no_trigger_v2, SiPM_11_2kV_no_trigger_v2};
	//std::vector<pulse_shape> pulses = {SiPM_10_4kV_no_trigger_v2, SiPM_09_5kV_no_trigger_v2, SiPM_08_6kV_no_trigger_v2, SiPM_07_8kV_no_trigger_v2};
  ...
  //std::vector<pulse_shape> pulses = {PMT4_17_3kV_no_trigger, PMT4_15_6kV_no_trigger, PMT4_13_8kV_no_trigger, PMT4_12_1kV_no_trigger, PMT4_11_2kV_no_trigger};
	//std::vector<pulse_shape> pulses = {PMT4_10_4kV_no_trigger, PMT4_09_5kV_no_trigger, PMT4_08_6kV_no_trigger, PMT4_07_8kV_no_trigger};
  //std::vector<pulse_shape> pulses = {PMT4_17_3kV_no_trigger_v2, PMT4_15_6kV_no_trigger_v2, PMT4_13_8kV_no_trigger_v2, PMT4_12_1kV_no_trigger_v2, PMT4_11_2kV_no_trigger_v2};
	//std::vector<pulse_shape> pulses = {PMT4_10_4kV_no_trigger_v2, PMT4_09_5kV_no_trigger_v2, PMT4_08_6kV_no_trigger_v2, PMT4_07_8kV_no_trigger_v2};

  //std::vector<pulse_shape> pulses = {SiPM_16kV_no_trigger, SiPM_15kV_no_trigger, SiPM_14kV_no_trigger, SiPM_13kV_no_trigger, SiPM_12kV_no_trigger};
  //std::vector<pulse_shape> pulses = {SiPM_11kV_no_trigger, SiPM_10kV_no_trigger, SiPM_09kV_no_trigger, SiPM_08kV_no_trigger};
  //std::vector<pulse_shape> pulses = {SiPM_16kV_no_trigger_v2, SiPM_15kV_no_trigger_v2, SiPM_14kV_no_trigger_v2, SiPM_13kV_no_trigger_v2, SiPM_12kV_no_trigger_v2};
  //std::vector<pulse_shape> pulses = {SiPM_11kV_no_trigger_v2, SiPM_10kV_no_trigger_v2, SiPM_09kV_no_trigger_v2, SiPM_08kV_no_trigger_v2};
