...
//For 210429/results_v5, same as 210128/compare_forms2.cpp
...
int compare_forms1 (void) {
	...
	double time_pretrigger_left = 3.0, time_pretrigger_right = 17.0; //13
...
define->folder = std::string("210429/results_v5/Pu_46V_17.3kV_850V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "8.2";
define->device = "SiPM-matrix";
define->fast_t_center = 28.33;
define->fast_t = PAIR(22.5, 30.4);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(30.7, 154);
define->long_fit_t = PAIR(30.7, 154);
...
define->slow_ampl_bound = PAIR(1e-2, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(7e-4, 1e-1);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;

	pulse_shape SiPM_15_6kV_no_trigger;
	define = &SiPM_15_6kV_no_trigger;
define->folder = std::string("210429/results_v5/Pu_46V_15.6kV_850V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "7.4";
define->device = "SiPM-matrix";
define->fast_t_center = 28.33;
define->fast_t = PAIR(22.5, 30.5);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->baseline_bound = PAIR(1e-6, 3e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-2, 7.5e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(7e-4, 1e-1);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
define->folder = std::string("210429/results_v5/Pu_46V_13.8kV_850V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "6.5";
define->device = "SiPM-matrix";
define->fast_t_center = 28.52;
...
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(4e-2, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-3, 1e-1);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
...
*define = *copy;
define->slow_fit_t = PAIR(31.6, 39.3);
define->long_fit_t = PAIR(70, 154);
define->baseline_bound = PAIR(1e-6, 3e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-2, 1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(6e-4, 1e-1);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;

	pulse_shape SiPM_12_1kV_no_trigger;
	define = &SiPM_12_1kV_no_trigger;
define->folder = std::string("210429/results_v5/Pu_46V_12.1kV_850V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "5.7";
define->device = "SiPM-matrix";
define->fast_t_center = 28.52;
define->fast_t = PAIR(22.0, 31.4);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->folder = std::string("210429/results_v5/Pu_46V_11.2kV_850V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "5.3";
define->device = "SiPM-matrix";
define->fast_t_center = 28.63;
define->fast_t = PAIR(21.0, 31.9);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-2, 2e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 1e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
...
*define = *copy;
define->slow_fit_t = PAIR(32.4, 41.0);
...
define->folder = std::string("210429/results_v5/Pu_46V_10.4kV_850V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.9";
define->device = "SiPM-matrix";
define->fast_t_center = 28.70;
define->fast_t = PAIR(21.0, 32.3);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(5e-3, 1e-1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 1e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
...
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 1.4e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 1e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
define->folder = std::string("210429/results_v5/Pu_46V_09.5kV_850V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.5";
define->device = "SiPM-matrix";
...
*define = *copy;
define->slow_fit_t = PAIR(32.8, 43.0);
define->long_fit_t = PAIR(63, 154);
define->baseline_bound = PAIR(1e-6, 5e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 1.05e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-4, 1e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
define->folder = std::string("210429/results_v5/Pu_46V_08.6kV_850V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.1";
define->device = "SiPM-matrix";
define->fast_t_center = 28.60;
define->fast_t = PAIR(21.0, 32.8);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(32.9, 63);
...
*define = *copy;
define->slow_fit_t = PAIR(32.6, 54.0);
define->long_fit_t = PAIR(0, 0);
define->baseline_bound = PAIR(1e-6, 8e-5);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 1e-1);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-5, 5e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;

	pulse_shape SiPM_07_8kV_no_trigger;
	define = &SiPM_07_8kV_no_trigger;
define->folder = std::string("210429/results_v5/Pu_46V_07.8kV_850V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "3.7";
define->device = "SiPM-matrix";
define->fast_t_center = 28.50;
define->fast_t = PAIR(21.0, 32.8);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
...
*define = *copy;
define->slow_fit_t = PAIR(34.0, 58.0);
define->long_fit_t = PAIR(0, 0);
...
define->folder = std::string("210429/results_v5/Pu_46V_06.9kV_850V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "3.3";
define->device = "SiPM-matrix";
define->fast_t_center = 28.38;
...
*define = *copy;
define->slow_fit_t = PAIR(34.5, 53.0);
define->long_fit_t = PAIR(0, 0);
define->baseline_bound = PAIR(1e-6, 1e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 1e-1);
...
define->fast_t_center = 28.16;
define->fast_t = PAIR(24, 30.2);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
*define = *copy;
define->slow_fit_t = PAIR(33.3, 41.7);
...
define->device.pop_back();
if (!fast_PMTs) define->device += " (slow)";
define->fast_t_center = 28.18;
define->fast_t = PAIR(24, 30.6);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
*define = *copy;
define->slow_fit_t = PAIR(33.3, 39.7);
define->long_fit_t = PAIR(65, 155);
define->baseline_bound = PAIR(1e-6, 2.5e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-2, 3.6e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(6e-4, 1.3e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
define->device.pop_back();
if (!fast_PMTs) define->device += " (slow)";
define->fast_t_center = 28.36;
define->fast_t = PAIR(23.5, 31.0);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
*define = *copy;
define->slow_fit_t = PAIR(33.0, 39.1);
define->long_fit_t = PAIR(60, 155);
define->baseline_bound = PAIR(1e-6, 1.5e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-2, 3e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(5e-4, 1e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
define->device.pop_back();
if (!fast_PMTs) define->device += " (slow)";
define->fast_t_center = 28.37;
define->fast_t = PAIR(23.5, 31.85);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->long_fit_t = PAIR(32.2, 155);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(5e-3, 5e-1);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(5e-3, 1.3e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(5e-4, 1e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
define->device.pop_back();
if (!fast_PMTs) define->device += " (slow)";
define->fast_t_center = 28.34;
define->fast_t = PAIR(23.5, 32.5);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(5e-3, 1.1e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(3e-4, 5e-2);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(33.3, 42.4);
define->long_fit_t = PAIR(53, 155);
define->baseline_bound = PAIR(1e-6, 9e-4);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(5e-3, 5e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(5e-4, 1.1e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
*define = *copy;
define->slow_fit_t = PAIR(33.5, 42.5);
...
*define = *copy;
define->slow_fit_t = PAIR(34.6, 44.7);
...
define->device.pop_back();
if (!fast_PMTs) define->device += " (slow)";
define->fast_t_center = 28.22;
define->fast_t = PAIR(23.0, 32.9);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
*define = *copy;
define->slow_fit_t = PAIR(33.8, 42.2);
...
*define = *copy;
define->slow_fit_t = PAIR(35.4, 56);
...
define->device.pop_back();
if (!fast_PMTs) define->device += " (slow)";
define->fast_t_center = 28.10;
define->fast_t = PAIR(23.0, 33.7);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->simultaneous_fit = false;
	...
	std::string folder = PMTs ? std::string("210429/results_v5/PMTs_v1/")
					: std::string("210429/results_v5/SiPMs_v1/");
