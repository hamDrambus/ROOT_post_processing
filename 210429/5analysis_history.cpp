...
void noise_cut(int channel, int aggressiveness, int device_condition, bool display) {
	...
	if (channel==2) {
		cut_A_S_upper(0.013, 0.0, 0.021, 0.0, display, channel, "rem_smallA_largeS_1");
	...
	if (channel==3) {
		cut_A_S_upper(0.01, 0.0, 0.017, 0.0, display, channel, "rem_smallA_largeS");
	...
	if (channel==4) {
		cut_A_S_upper(0.01, 0.0, 0.017, 0.0, display, channel, "rem_smallA_largeS_1");
...
S2_times["210429_Cd_17.3kV_850V_46V_12dB"] = std::pair<double, double> (23, 34);
S2_times["210429_Cd_15.6kV_850V_46V_12dB"] = std::pair<double, double> (23, 33);
S2_times["210429_Cd_13.8kV_850V_46V_12dB"] = std::pair<double, double> (23, 33);
S2_times["210429_Cd_12.1kV_850V_46V_12dB"] = std::pair<double, double> (23, 33);
S2_times["210429_Cd_11.2kV_850V_46V_12dB"] = std::pair<double, double> (23, 33);
S2_times["210429_Cd_10.4kV_850V_46V_12dB"] = std::pair<double, double> (23, 33);
S2_times["210429_Cd_9.5kV_850V_46V_12dB"] = std::pair<double, double> (23, 33.5);
S2_times["210429_Cd_8.6kV_850V_46V_12dB"] = std::pair<double, double> (23, 34.0);
S2_times["210429_Cd_7.8kV_850V_46V_12dB"] = std::pair<double, double> (23, 34.5);
S2_times["210429_Cd_6.9kV_850V_46V_12dB"] = std::pair<double, double> (23, 35.5);

std::map<std::string, std::string> exp_folders;
exp_folders["210429_Cd_17.3kV_850V_46V_12dB"] = "Pu_46V_17.3kV_850V";
exp_folders["210429_Cd_15.6kV_850V_46V_12dB"] = "Pu_46V_15.6kV_850V";
exp_folders["210429_Cd_13.8kV_850V_46V_12dB"] = "Pu_46V_13.8kV_850V";
exp_folders["210429_Cd_12.1kV_850V_46V_12dB"] = "Pu_46V_12.1kV_850V";
exp_folders["210429_Cd_11.2kV_850V_46V_12dB"] = "Pu_46V_11.2kV_850V";
exp_folders["210429_Cd_10.4kV_850V_46V_12dB"] = "Pu_46V_10.4kV_850V";
exp_folders["210429_Cd_9.5kV_850V_46V_12dB"] = "Pu_46V_09.5kV_850V";
exp_folders["210429_Cd_8.6kV_850V_46V_12dB"] = "Pu_46V_08.6kV_850V";
exp_folders["210429_Cd_7.8kV_850V_46V_12dB"] = "Pu_46V_07.8kV_850V";
exp_folders["210429_Cd_6.9kV_850V_46V_12dB"] = "Pu_46V_06.9kV_850V";

std::map<std::string, double> pre_trigger_max_S; //for calibration
pre_trigger_max_S["210429_Cd_17.3kV_850V_46V_12dB"] = 0.34;
pre_trigger_max_S["210429_Cd_15.6kV_850V_46V_12dB"] = 0.26;
pre_trigger_max_S["210429_Cd_13.8kV_850V_46V_12dB"] = 0.21;
pre_trigger_max_S["210429_Cd_12.1kV_850V_46V_12dB"] = 0.19;
pre_trigger_max_S["210429_Cd_11.2kV_850V_46V_12dB"] = 0.18;
pre_trigger_max_S["210429_Cd_10.4kV_850V_46V_12dB"] = 0.16;
pre_trigger_max_S["210429_Cd_9.5kV_850V_46V_12dB"] = 0.16;
pre_trigger_max_S["210429_Cd_8.6kV_850V_46V_12dB"] = 0.16;
pre_trigger_max_S["210429_Cd_7.8kV_850V_46V_12dB"] = 0.16;
pre_trigger_max_S["210429_Cd_6.9kV_850V_46V_12dB"] = 0.16;
...
ty(AStates::PMT_A_S);
    ...
    set_bins(1500);
    noise_cut(channel, 1, PMT_state, true);
    saveaspng(data_output_path+folder+"/calibration/"+ch_str+"_A_S");
    set_zoom(0, 0.06, 0, 0.006);
    saveas(data_output_path+folder+"/calibration/"+ch_str+"_A_S_zoom");
    set_bins(120);
    saveaspng(data_output_path+folder+"/calibration/"+ch_str+"_A_S_zoom2");
ty(AStates::PMT_Ss);
    set_zoom(0, 0.001);
    set_bins(800);
    ...
    saveaspng(data_output_path+folder+"/calibration/"+ch_str+"_Ss_w_0-"+S2_start+"us");
    set_use_mean(); //overwrites old info from calibration file!
    unset_1peS(); //updates calibration if it was loaded from file
    update();
}
...
ty(AStates::PMT_A_S);
    ...
    saveaspng(data_output_path+folder+"/calibration/"+ch_str+"_A_S_zoom");
    set_bins(120);
    saveaspng(data_output_path+folder+"/calibration/"+ch_str+"_A_S_zoom2");
		set_log_z();
    saveaspng(data_output_path+folder+"/calibration/"+ch_str+"_A_S_zoom2_log");
ty(AStates::PMT_Ss);
    set_zoom(0, 0.002);
    set_bins(800);
    saveaspng(data_output_path+folder+"/calibration/"+ch_str+"_Ss");
...
//zcxv
if (exp == "210429_Cd_17.3kV_850V_46V_12dB") {
...
if (exp == "210429_Cd_15.6kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_bins(180);
	x_y_regions = {27.5, 0, 179.9, 109.7};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_"+S2_start+"-160us");
...
if (exp == "210429_Cd_13.8kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_bins(150);
	x_y_regions = {16.4, 0, 26.7, 5.1, 149.9, 104.3};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_"+S2_start+"-160us");
...
if (exp == "210429_Cd_12.1kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 150, 0, 150);
	set_bins(150);
	x_y_regions = {11.3, 0, 20.0, 4.8, 149.9, 123};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_"+S2_start+"-160us");
...
if (exp == "210429_Cd_11.2kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 150, 0, 150);
	set_bins(150);
	x_y_regions = {7.9, 0, 17.1, 4.3, 149.9, 135};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_"+S2_start+"-160us");
...
if (exp == "210429_Cd_10.4kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 150, 0, 150);
	set_bins(150);
	x_y_regions = {5.9, 0, 13.4, 3.8, 149.9, 135.2};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_"+S2_start+"-160us");
...
if (exp == "210429_Cd_9.5kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 150, 0, 150);
	set_bins(150);
	x_y_regions = {4.36, 0, 11.7, 3.14, 149.9, 138.3};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_"+S2_start+"-160us");
...
if (exp == "210429_Cd_8.6kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 150, 0, 150);
	set_bins(150);
	x_y_regions = {4.2, 0, 8.5, 1.2, 149.9, 137.4};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_"+S2_start+"-160us");
...
if (exp == "210429_Cd_7.8kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
...
set_corr(AStates::MPPC_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
	...
	set_zoom(0, 150, 0, 150);
	set_bins(150);
	x_y_regions = {4.1, 0, 8.4, 1.2, 149.8, 137.4};
	cut_x_y_right(x_y_regions, true, "1");
	update();
	set_titles("N_{pe} t#in[0, 160] #mus", "N_{pe} t#in["+S2_start+", "+S2_finish+"] #mus");
	saveaspng(FOLDER + Num + "_SiPMs_Npe_"+cuts_str(cuts)+"_"+S2_start+"-"+S2_finish+"us_vs_"+S2_start+"-160us");
...
if (exp == "210429_Cd_6.9kV_850V_46V_12dB") {
	std::vector<std::string> cuts;
	std::string zoomx = "Npe" + dbl_to_str(160-d_S2_start, 0);
	std::string zoomy = "Npe" + dbl_to_str(d_S2_finish-d_S2_start, 0);
	int no = 0; //picture number
