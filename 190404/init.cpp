{
  ...
  PMT_V.clear();
  PMT_V["190404_Cd_20kV_850V_46V_th250mV_0"] = 850;
  PMT_V["190404_Cd_20kV_850V_46V_th250mV"] = 850;
  PMT_V["190404_Cd_18kV_850V_46V_th230mV"] = 850;
  PMT_V["190404_Cd_16kV_850V_46V_th210mV"] = 850;

  PMT_dB.clear();
  //There are dB, but calibration will be done using this very signals.
  PMT_dB["190404_Cd_20kV_850V_46V_th250mV_0"] = 1.0; //ratio, not actual dB. 6dB = 2.0, 12dB = 3.98
  PMT_dB["190404_Cd_20kV_850V_46V_th250mV"] = 1.0;
  PMT_dB["190404_Cd_18kV_850V_46V_th230mV"] = 1.0;
  PMT_dB["190404_Cd_16kV_850V_46V_th210mV"] = 1.0;
