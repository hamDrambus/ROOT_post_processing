{
  ...
  data_prefix_path = "../Data/210218/results_v1/";
  ...
  exp_area.experiments.push_back("210218_Pu_5.5kV_850V_0V_12dB_th250mV");
  exp_area.experiments.push_back("210218_Pu_5.5kV_850V_0V_12dB_th2V");
  ...
  experiment_fields["210218_Pu_5.5kV_850V_0V_12dB_th2V"] = 5.5;
  experiment_fields["210218_Pu_5.5kV_850V_0V_12dB_th250mV"] = 5.5;

  std::map<std::string, int> experiment_runs; //required for printing accpeted/rejected events
  experiment_runs["210218_Pu_5.5kV_850V_0V_12dB_th2V"] = 1;
  experiment_runs["210218_Pu_5.5kV_850V_0V_12dB_th250mV"] = 52;
