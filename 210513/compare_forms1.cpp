...
//For 210513/results_v5, same as 210128/compare_forms2.cpp and 210429/compare_forms1.cpp
...
define->simultaneous_fit = false;
	...
	pulse_shape SiPM_20kV_800V_no_trigger;
	define = &SiPM_20kV_800V_no_trigger;
define->folder = std::string("210513/results_v5/Cd_46V_20kV_800V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "8.4";
define->device = "SiPM-matrix (800V PMT)";
define->fast_t_center = 29.15;
define->fast_t = PAIR(22.5, 30.8);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
...
define->folder = std::string("210513/results_v5/Cd_46V_11kV_850V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.6";
define->device = "SiPM-matrix";
define->fast_t_center = 29.2;
define->fast_t = PAIR(21.0, 33.3);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->folder = std::string("210513/results_v5/Cd_46V_10kV_850V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "4.2";
define->device = "SiPM-matrix";
define->fast_t_center = 29.2;
define->fast_t = PAIR(21.0, 33.4);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 1.1e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(1e-5, 6e-4);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(35.0, 56.0);
define->long_fit_t = PAIR(63.5, 154);
define->baseline_bound = PAIR(1e-6, 4e-5);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 9e-3);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->folder = std::string("210513/results_v5/Cd_46V_09kV_850V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "3.8";
define->device = "SiPM-matrix";
define->fast_t_center = 29.40;
define->fast_t = PAIR(20.0, 33.5);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1;
define->subtract_baseline = subtact_baseline;
...
define->slow_tau_bound = PAIR(2.5, 12);
define->long_ampl_bound = PAIR(1e-5, 2e-3);
define->long_tau_bound = PAIR(16, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(36.0, 58.0);
define->long_fit_t = PAIR(66, 154);
define->baseline_bound = PAIR(1e-6, 2.5e-5);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 5e-2);
define->slow_tau_bound = PAIR(2.5, 12);
define->long_ampl_bound = PAIR(1e-5, 1e-3);
...
define->folder = std::string("210513/results_v5/Cd_46V_08kV_850V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "3.4";
define->device = "SiPM-matrix";
define->fast_t_center = 29.1;
...
define->subtract_baseline = subtact_baseline;
define->renormalize = true;
define->slow_fit_t = PAIR(33.7, 154);
define->long_fit_t = PAIR(33.7, 154);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(2e-3, 5e-2);
define->slow_tau_bound = PAIR(2.5, 12);
define->long_ampl_bound = PAIR(2e-5, 5e-3);
define->long_tau_bound = PAIR(16, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(35.6, 57.0);
define->long_fit_t = PAIR(71, 154);
define->baseline_bound = PAIR(1e-6, 9e-5);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-3, 5e-2);
define->slow_tau_bound = PAIR(2.5, 12);
...
define->simultaneous_fit = false;
	...
	pulse_shape PMT4_20kV_800V_no_trigger;
	define = &PMT4_20kV_800V_no_trigger;
define->folder = std::string("210513/results_v5/Cd_46V_20kV_800V/") + (Cd_peak ? "forms_Cd_peak/" : "forms_Cd_left/");
if(PMT_used&0x1) define->fnames.push_back(fast_PMTs ? "5_form_by_Npe.hdata" : "1_form_by_Npe.hdata");
if(PMT_used&0x2) define->fnames.push_back(fast_PMTs ? "6_form_by_Npe.hdata" : "2_form_by_Npe.hdata");
if(PMT_used&0x4) define->fnames.push_back(fast_PMTs ? "7_form_by_Npe.hdata" : "3_form_by_Npe.hdata");
...
*define = *copy;
define->slow_fit_t = PAIR(34.3, 41.0);
...
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(5e-5, 5e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = true;
define->do_fit = do_fit;
define->fit_option = def_fit_option;
...
*define = *copy;
define->slow_fit_t = PAIR(34.2, 41.2);
define->long_fit_t = PAIR(50, 155);
...
define->slow_ampl_bound = PAIR(1e-3, 1e-2);
define->slow_tau_bound = PAIR(2.5, 10);
define->long_ampl_bound = PAIR(7e-5, 5e-3);
define->long_tau_bound = PAIR(15, 200);
define->simultaneous_fit = false;
...
*define = *copy;
define->slow_fit_t = PAIR(35.2, 42);
define->long_fit_t = PAIR(52, 155);
define->baseline_bound = PAIR(1e-6, 1e-3);
define->long_baseline_bound = PAIR(1e-6, 1e-6);
...
*define = *copy;
define->slow_fit_t = PAIR(35.3, 43.5);
define->long_fit_t = PAIR(55, 155);
...
define->simultaneous_fit = false;
	...
	std::string folder = PMTs ? std::string("210513/results_v5/PMTs_v1/")
					: std::string("210513/results_v5/SiPMs_v1/");
	...
	std::vector<pulse_shape> pulses = {SiPM_12kV_no_trigger, SiPM_11kV_no_trigger, SiPM_10kV_no_trigger, SiPM_09kV_no_trigger, SiPM_08kV_no_trigger};
	...
	//std::vector<pulse_shape> pulses = {SiPM_12kV_no_trigger_v2, SiPM_11kV_no_trigger_v2, SiPM_10kV_no_trigger_v2, SiPM_09kV_no_trigger_v2, SiPM_08kV_no_trigger_v2};

	//std::vector<pulse_shape> pulses = {PMT4_20kV_no_trigger, PMT4_18kV_no_trigger, PMT4_16kV_no_trigger, PMT4_14kV_no_trigger, PMT4_13kV_no_trigger};
	//std::vector<pulse_shape> pulses = {PMT4_12kV_no_trigger, PMT4_11kV_no_trigger, PMT4_10kV_no_trigger, PMT4_09kV_no_trigger, PMT4_08kV_no_trigger};
	//std::vector<pulse_shape> pulses = {PMT4_20kV_no_trigger_v2, PMT4_18kV_no_trigger_v2, PMT4_16kV_no_trigger_v2, PMT4_14kV_no_trigger_v2, PMT4_13kV_no_trigger_v2};
	//std::vector<pulse_shape> pulses = {PMT4_12kV_no_trigger_v2, PMT4_11kV_no_trigger_v2, PMT4_10kV_no_trigger_v2, PMT4_09kV_no_trigger_v2, PMT4_08kV_no_trigger_v2};
