...
int compare_forms_S1(void) {
  ...
  double max_val = 0;
  double trigger_at = center_at_S1 ? 32 : 32;
  double y_min = 1e-4;
...
define->folder = "231109/results_v1/X-ray_14mm_coll_20kV/forms_X-ray/";
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "20";
define->device = "SiPM matrix, Ar + 913 ppm N2";
define->fast_t_center = 32.7;
define->fast_t = PAIR(31, 45);
...
*define = *copy;
define->folder = "231109/results_v1/X-ray_14mm_coll_18kV/forms_X-ray/";
define->Td = "18";
define->scale = 1;
define->slow_fit_t = PAIR(55, 160);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape SiPM_N2_16kV_no_trigger;
  define = &SiPM_N2_16kV_no_trigger;
  copy = &SiPM_N2_20kV_no_trigger;
*define = *copy;
define->folder = "231109/results_v1/X-ray_14mm_coll_16kV/forms_X-ray/";
define->Td = "16";
define->scale = 1;
define->slow_fit_t = PAIR(55, 160);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape SiPM_N2_14kV_no_trigger;
  define = &SiPM_N2_14kV_no_trigger;
  copy = &SiPM_N2_20kV_no_trigger;
*define = *copy;
define->folder = "231109/results_v1/X-ray_14mm_coll_14kV/forms_X-ray/";
define->Td = "14";
define->scale = 1;
define->slow_fit_t = PAIR(55, 160);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(20, 200);
  ...
  copy = &SiPM_N2_20kV_no_trigger;
*define = *copy;
define->folder = "231109/results_v1/X-ray_14mm_coll_12kV/forms_X-ray/";
define->Td = "12";
define->scale = 1;
define->slow_fit_t = PAIR(55, 160);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape SiPM_N2_10kV_no_trigger;
  define = &SiPM_N2_10kV_no_trigger;
  copy = &SiPM_N2_20kV_no_trigger;
*define = *copy;
define->folder = "231109/results_v1/X-ray_14mm_coll_10kV/forms_X-ray/";
define->Td = "10";
define->scale = 1;
define->slow_fit_t = PAIR(55, 160);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape SiPM_N2_08kV_no_trigger;
  define = &SiPM_N2_08kV_no_trigger;
  copy = &SiPM_N2_20kV_no_trigger;
*define = *copy;
define->folder = "231109/results_v1/X-ray_14mm_coll_08kV/forms_X-ray/";
define->Td = "8";
define->scale = 1;
define->slow_fit_t = PAIR(55, 160);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape SiPM_N2_00kV_no_trigger;
  define = &SiPM_N2_00kV_no_trigger;
  copy = &SiPM_N2_20kV_no_trigger;
*define = *copy;
define->folder = "231109/results_v1/X-ray_14mm_coll_00kV/forms_X-ray/";
define->Td = "0";
define->scale = 1;
define->slow_fit_t = PAIR(55, 160);
define->slow_ampl_bound = PAIR(1e-3, 1);
...
define->folder = "221124/results_v3/X-ray_14mm_filt3_20kV/forms_X-ray/";
define->fnames = {"SiPMs_form_by_Npe.hdata"};
define->Td = "20";
...
*define = *copy;
define->folder = "221124/results_v3/X-ray_14mm_filt3_18kV/forms_X-ray/";
define->Td = "18";
define->scale = 1;
define->slow_fit_t = PAIR(55, 160);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape SiPM_Ar_16kV_no_trigger;
  define = &SiPM_Ar_16kV_no_trigger;
  copy = &SiPM_Ar_20kV_no_trigger;
*define = *copy;
define->folder = "221124/results_v3/X-ray_14mm_filt3_16kV/forms_X-ray/";
define->Td = "16";
define->scale = 1;
define->slow_fit_t = PAIR(55, 160);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape SiPM_Ar_14kV_no_trigger;
  define = &SiPM_Ar_14kV_no_trigger;
  copy = &SiPM_Ar_20kV_no_trigger;
*define = *copy;
define->folder = "221124/results_v3/X-ray_14mm_filt3_14kV/forms_X-ray/";
define->Td = "14";
define->scale = 1;
define->slow_fit_t = PAIR(55, 160);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(20, 200);
  ...
  copy = &SiPM_Ar_20kV_no_trigger;
*define = *copy;
define->folder = "221124/results_v3/X-ray_14mm_filt3_12kV/forms_X-ray/";
define->Td = "12";
define->scale = 1;
define->slow_fit_t = PAIR(55, 160);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape SiPM_Ar_10kV_no_trigger;
  define = &SiPM_Ar_10kV_no_trigger;
  copy = &SiPM_Ar_20kV_no_trigger;
*define = *copy;
define->folder = "221124/results_v3/X-ray_14mm_filt3_10kV/forms_X-ray/";
define->Td = "10";
define->scale = 1;
define->slow_fit_t = PAIR(55, 160);
define->slow_ampl_bound = PAIR(1e-3, 1);
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape SiPM_Ar_08kV_no_trigger;
  define = &SiPM_Ar_08kV_no_trigger;
  copy = &SiPM_Ar_20kV_no_trigger;
*define = *copy;
define->folder = "221124/results_v3/X-ray_14mm_filt3_08kV/forms_X-ray/";
define->Td = "8";
define->scale = 1;
define->slow_fit_t = PAIR(55, 160);
define->slow_ampl_bound = PAIR(1e-3, 1);
...
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape PMT4_N2_16kV_no_trigger;
  define = &PMT4_N2_16kV_no_trigger;
  copy = &PMT4_N2_20kV_no_trigger;
*define = *copy;
define->folder = "231109/results_v1/X-ray_14mm_coll_16kV/forms_X-ray/";
define->Td = "16";
...
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape PMT4_N2_14kV_no_trigger;
  define = &PMT4_N2_14kV_no_trigger;
  copy = &PMT4_N2_20kV_no_trigger;
*define = *copy;
define->folder = "231109/results_v1/X-ray_14mm_coll_14kV/forms_X-ray/";
define->Td = "14";
...
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape PMT4_N2_10kV_no_trigger;
  define = &PMT4_N2_10kV_no_trigger;
  copy = &PMT4_N2_20kV_no_trigger;
*define = *copy;
define->folder = "231109/results_v1/X-ray_14mm_coll_10kV/forms_X-ray/";
define->Td = "10";
...
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape PMT4_N2_08kV_no_trigger;
  define = &PMT4_N2_08kV_no_trigger;
  copy = &PMT4_N2_20kV_no_trigger;
*define = *copy;
define->folder = "231109/results_v1/X-ray_14mm_coll_08kV/forms_X-ray/";
define->Td = "8";
...
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape PMT4_N2_00kV_no_trigger;
  define = &PMT4_N2_00kV_no_trigger;
  copy = &PMT4_N2_20kV_no_trigger;
*define = *copy;
define->folder = "231109/results_v1/X-ray_14mm_coll_00kV/forms_X-ray/";
define->Td = "0";
...
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape PMT4_Ar_16kV_no_trigger;
  define = &PMT4_Ar_16kV_no_trigger;
  copy = &PMT4_Ar_20kV_no_trigger;
*define = *copy;
define->folder = "221124/results_v3/X-ray_14mm_filt3_16kV/forms_X-ray/";
define->Td = "16";
...
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape PMT4_Ar_14kV_no_trigger;
  define = &PMT4_Ar_14kV_no_trigger;
  copy = &PMT4_Ar_20kV_no_trigger;
*define = *copy;
define->folder = "221124/results_v3/X-ray_14mm_filt3_14kV/forms_X-ray/";
define->Td = "14";
...
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape PMT4_Ar_10kV_no_trigger;
  define = &PMT4_Ar_10kV_no_trigger;
  copy = &PMT4_Ar_20kV_no_trigger;
*define = *copy;
define->folder = "221124/results_v3/X-ray_14mm_filt3_10kV/forms_X-ray/";
define->Td = "10";
...
define->slow_tau_bound = PAIR(20, 200);
  ...
  pulse_shape PMT4_Ar_08kV_no_trigger;
  define = &PMT4_Ar_08kV_no_trigger;
  copy = &PMT4_Ar_20kV_no_trigger;
*define = *copy;
define->folder = "221124/results_v3/X-ray_14mm_filt3_08kV/forms_X-ray/";
define->Td = "8";
...
define->slow_tau_bound = PAIR(20, 200);
  ...
  //std::vector<pulse_shape> pulses = {SiPM_Ar_20kV_no_trigger, SiPM_Ar_14kV_no_trigger, SiPM_Ar_08kV_no_trigger};
  ...
  for (int hh = 0, hh_end_ = pulses.size(); hh!=hh_end_; ++hh) {
    ...
    if (pulses[hh].tau1.empty() || pulses[hh].tau1 == "--")
      ...
      tau1.push_back("#tau=" + pulses[hh].tau1 + (print_errors ? "#pm" + pulses[hh].tau1_err : unit));
  ...
  if (!linear) {
    ...
    if (print_errors) { //zcxv - for fast Crtl+F
      ...
      add_text(67, 0.03, no_title, tau1, palette_major);
      add_text(117, 0.03, Slow_title, frsS, palette_major);
  ...
  for (int hh = 0, hh_end_ = pulses.size(); hh!=hh_end_; ++hh) {
    legend->AddEntry(pulses[hh].hist, (std::string("V_{0} = ") + pulses[hh].Td + " kV, " + pulses[hh].device).c_str(), "l");
  }
