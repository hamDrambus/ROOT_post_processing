...
define->slow_tau_bound = PAIR(20, 200);
  ...
  // std::vector<pulse_shape> pulses = {SiPM_N2_20kV_no_trigger, SiPM_Ar_20kV_no_trigger};
  // std::vector<pulse_shape> pulses = {SiPM_N2_18kV_no_trigger, SiPM_Ar_18kV_no_trigger};
  // std::vector<pulse_shape> pulses = {SiPM_N2_12kV_no_trigger, SiPM_Ar_12kV_no_trigger};
  // std::vector<pulse_shape> pulses = {PMT4_N2_20kV_no_trigger, PMT4_Ar_20kV_no_trigger};
  // std::vector<pulse_shape> pulses = {PMT4_N2_18kV_no_trigger, PMT4_Ar_18kV_no_trigger};
  std::vector<pulse_shape> pulses = {PMT4_N2_12kV_no_trigger, PMT4_Ar_12kV_no_trigger};
  //for paper:
