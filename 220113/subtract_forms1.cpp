...
int subtract_forms1 (void) {
  ...
  bool print_results = true;
	...
	pulse_shape SiPM_2873V_no_trigger_v3;
	define = &SiPM_2873V_no_trigger_v3;
...
define->THGEM_fast_t = PAIR(28.2, 31.8);
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_2155V_no_trigger_v3;
  define = &SiPM_2155V_no_trigger_v3;
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_1797V_no_trigger_v3;
...
pulse_shape SiPM_1616V_no_trigger_v3;
define = &SiPM_1616V_no_trigger_v3;
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_1330V_no_trigger_v3;
...
define->fast_t = PAIR(25.4, 28.5);
define->THGEM_fast_t = PAIR(28.4, 31.8);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 1.0;
define->subtract_baseline = subtact_baseline;
...
define->long_fit_t = PAIR(32.0, 154);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(1e-2, 1.5e-1);
define->slow_tau_bound = PAIR(2.5, 10);
...
define->fit_option = def_fit_option;
  ...
  pulse_shape SiPM_1065V_no_trigger_v3;
...
pulse_shape SiPM_0852V_no_trigger_v3;
define = &SiPM_0852V_no_trigger_v3;
...
define->long_fit_t = PAIR(32.0, 154);
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(7e-3, 1e-1);
define->slow_tau_bound = PAIR(2.5, 10);
...
pulse_shape SiPM_0745V_no_trigger_v3;
define = &SiPM_0745V_no_trigger_v3;
...
define->baseline_bound = PAIR(1e-6, 1e-6);
define->slow_ampl_bound = PAIR(4e-3, 1e-1);
define->slow_tau_bound = PAIR(2.5, 10);
...
pulse_shape SiPM_0639V_no_trigger_v3;
define = &SiPM_0639V_no_trigger_v3;
...
pulse_shape SiPM_0533V_no_trigger_v3;
define = &SiPM_0533V_no_trigger_v3;
...
pulse_shape SiPM_0425V_no_trigger_v3;
define = &SiPM_0425V_no_trigger_v3;
...
pulse_shape SiPM_0318V_no_trigger_v3;
define = &SiPM_0318V_no_trigger_v3;
...
pulse_shape SiPM_0000V_no_trigger_v4;
define = &SiPM_0000V_no_trigger_v4;
...
define->fast_t_center = 28.7;
define->fast_t = PAIR(25.4, 28.50-define->t_offset);
define->S1_t_center = 0;
define->S1_t = PAIR(0, 0);
define->scale = 0.98;
define->subtract_baseline = subtact_baseline;
...
std::string folder = PMTs ? std::string("220113/results_v5/PMTs_v1/")
  ...
  //std::vector<pulse_shape*> pulses_baseline = {&SiPM_0000V_no_trigger_v3, &SiPM_0000V_no_trigger_v3};

  //std::vector<pulse_shape*> pulses = {&SiPM_0318V_no_trigger_v3, &SiPM_0000V_no_trigger_v3};
  //std::vector<pulse_shape*> pulses = {&SiPM_0425V_no_trigger_v3, &SiPM_0000V_no_trigger_v3};
  //std::vector<pulse_shape*> pulses = {&SiPM_0533V_no_trigger_v3, &SiPM_0000V_no_trigger_v3};
  //std::vector<pulse_shape*> pulses = {&SiPM_0639V_no_trigger_v3, &SiPM_0000V_no_trigger_v3};
  //std::vector<pulse_shape*> pulses = {&SiPM_0745V_no_trigger_v3, &SiPM_0000V_no_trigger_v3};
  //std::vector<pulse_shape*> pulses = {&SiPM_0852V_no_trigger_v3, &SiPM_0000V_no_trigger_v3};
  //std::vector<pulse_shape*> pulses = {&SiPM_1065V_no_trigger_v3, &SiPM_0000V_no_trigger_v3};
  //std::vector<pulse_shape*> pulses = {&SiPM_1330V_no_trigger_v3, &SiPM_0000V_no_trigger_v3};
  //std::vector<pulse_shape*> pulses = {&SiPM_1616V_no_trigger_v3, &SiPM_0000V_no_trigger_v3};
  //std::vector<pulse_shape*> pulses = {&SiPM_1797V_no_trigger_v3, &SiPM_0000V_no_trigger_v3};
  //std::vector<pulse_shape*> pulses = {&SiPM_2155V_no_trigger_v3, &SiPM_0000V_no_trigger_v3};
  //std::vector<pulse_shape*> pulses = {&SiPM_2513V_no_trigger_v3, &SiPM_0000V_no_trigger_v3};
  //std::vector<pulse_shape*> pulses = {&SiPM_2873V_no_trigger_v3, &SiPM_0000V_no_trigger_v3};
  ...
  //std::vector<pulse_shape*> pulses = {&SiPM_2873V_no_trigger_v3, &SiPM_1065V_no_trigger_v3, &SiPM_0745V_no_trigger_v3};
  ...
  std::vector<std::string> forced_taus1 = {"4.0", "3.9", ""}; //SiPMs: 1797V, 1330V, 0V
  ...
  pre_setts.max_val*= linear ? 1.2 : 2;
	...
	if (!linear)
		...
		frame->GetXaxis()->SetRangeUser(25, 40);
	//=====================================
