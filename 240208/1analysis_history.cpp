...
void noise_cut(int channel, int aggressiveness, int device_condition, bool display) {
    ...
    if (0 == device_condition) {
        ...
        if (channel==5) {
            ...
            x_y_regions = {0.0025, 0.0025, 0.000125, 0.03, 0.00150, 1e3};
        ...
        if (channel==7) {
            // cut_A_S_lower(0.0, 0.00032, 0.010, 0.0, display, channel, "small_A-S_noise");
            x_y_regions = {0.0020, 0.0020, 0.000149, 0.03, 0.00151, 1e3};
            cut_A_S_fast_PMT(x_y_regions, display, channel, "small_A-S_noise2");
            if (aggressiveness == 1) {
                cut_A_S_upper(0.65, 0, 5, 0, display, channel, "rem_A>0.65");
                cut_A_S_upper(0.0, 0.030, 1.6, 0.030, display, channel, "rem_S>0.030");
        ...
        if (channel==8) {
            // cut_A_S_lower(0.0, 0.00032, 0.010, 0.0, display, channel, "small_A-S_noise");
            x_y_regions = {0.0020, 0.0020, 0.000149, 0.03, 0.00148, 1e3};
            cut_A_S_fast_PMT(x_y_regions, display, channel, "small_A-S_noise2");
            if (aggressiveness == 1) {
                cut_A_S_upper(0.65, 0, 5, 0, display, channel, "rem_A>0.65");
                cut_A_S_upper(0.0, 0.030, 1.6, 0.030, display, channel, "rem_S>0.030");
    ...
    if (channel==34) {
        ...
        if (aggressiveness>=2)//remove afterimpulses
            cut_A_S_upper(0.0055, 0.00152, 0.0157, 0.00337, display, channel, "2pe_merged");
    }
    if (channel==35) {
    ...
    if (channel==38) {
        ...
        if (aggressiveness>=2)//remove afterimpulses
            cut_A_S_upper(0.0064, 0.00161, 0.0163, 0.00360, display, channel, "2pe_merged");
    }
    if (channel==39) {
    ...
    if (channel==50) {
        cut_A_S_lower(0.0040, 0.00054, 0.01, 0.00115, display, channel, "small_A-S_noise");
        x_y_regions = {0.0040, 0.0040, 0.00030, 0.05, 0.0085, 1e3};
        cut_A_S_fast_PMT(x_y_regions, display, channel, "small_A-S_noise2");
        if (aggressiveness>=1)//select only 1 photoelectron for calibration
            cut_A_S_upper(0.0106, 0.0001, 1, 0.0001, display, channel, "2pe");
        if (aggressiveness>=2)//remove afterimpulses
            cut_A_S_upper(0.0040, 0.00113, 0.0106, 0.0024, display, channel, "2pe_merged");
    }
    if (channel==51) {
    ...
    if (channel==54) {
        // cut_A_S_lower(0.0060, 0.00100, 0.015, 0.00100, display, channel, "small_A-S_noise");
        x_y_regions = {0.0060, 0.0060, 0.00073, 0.05, 0.0089, 1e3};
        cut_A_S_fast_PMT(x_y_regions, display, channel, "small_A-S_noise2");
        if (aggressiveness>=1)//select only 1 photoelectron for calibration
            cut_A_S_upper(0.0142, 0.0001, 1, 0.0001, display, channel, "2pe");
        if (aggressiveness>=2)//remove afterimpulses
            cut_A_S_upper(0.0060, 0.00152, 0.0142, 0.00308, display, channel, "2pe_merged");
    }
    if (channel==55) {
...
// Analyzing S1 and S2 in pure LAr.
...
// Output is signal pulse-shapes and Npe for pre-trigger, S1 and S2 due to NBrS in LAr.
// Pulse-shapes for bubble events are plotted separetely.
// Use histogram_2D_animated.py to plot 2D SiPM vs PMT Npe behavior in time.

// Setup: single-phase, X-ray with 14 mm collimator,
...
exp_folders["240208_LAr_X-ray_Q_14mm_coll_8kV_850V_46V"] = "X-ray_14mm_coll_V0_08kV";
exp_folders["240208_LAr_X-ray_Q_14mm_coll_10kV_850V_46V"] = "X-ray_14mm_coll_V0_10kV";
exp_folders["240208_LAr_X-ray_Q_14mm_coll_12kV_850V_46V"] = "X-ray_14mm_coll_V0_12kV";
exp_folders["240208_LAr_X-ray_Q_14mm_coll_14kV_850V_46V"] = "X-ray_14mm_coll_V0_14kV";
exp_folders["240208_LAr_X-ray_Q_14mm_coll_16kV_850V_46V"] = "X-ray_14mm_coll_V0_16kV";
exp_folders["240208_LAr_X-ray_Q_14mm_coll_18kV_850V_46V"] = "X-ray_14mm_coll_V0_18kV";
exp_folders["240208_LAr_X-ray_Q_14mm_coll_20kV_850V_46V"] = "X-ray_14mm_coll_V0_20kV";
exp_folders["240208_LAr_X-ray_14mm_coll_0V_850V_46V"] = "X-ray_14mm_coll_000V";
exp_folders["240208_LAr_X-ray_14mm_coll_139V_850V_46V"] = "X-ray_14mm_coll_139V";
exp_folders["240208_LAr_X-ray_14mm_coll_185V_850V_46V"] = "X-ray_14mm_coll_185V";
exp_folders["240208_LAr_X-ray_14mm_coll_231V_850V_46V"] = "X-ray_14mm_coll_231V";
exp_folders["240208_LAr_X-ray_14mm_coll_277V_850V_46V"] = "X-ray_14mm_coll_277V";
exp_folders["240208_LAr_X-ray_14mm_coll_323V_850V_46V"] = "X-ray_14mm_coll_323V";
exp_folders["240208_LAr_X-ray_14mm_coll_369V_850V_46V"] = "X-ray_14mm_coll_369V";
exp_folders["240208_LAr_X-ray_14mm_coll_416V_850V_46V"] = "X-ray_14mm_coll_416V";
exp_folders["240208_LAr_X-ray_14mm_coll_462V_850V_46V"] = "X-ray_14mm_coll_462V";
exp_folders["240208_LAr_X-ray_14mm_coll_508V_850V_46V"] = "X-ray_14mm_coll_508V";
exp_folders["240208_LAr_X-ray_14mm_coll_554V_850V_46V"] = "X-ray_14mm_coll_554V";
exp_folders["240208_LAr_X-ray_14mm_coll_600V_850V_46V"] = "X-ray_14mm_coll_600V";
exp_folders["240208_LAr_X-ray_14mm_coll_646V_850V_46V"] = "X-ray_14mm_coll_646V";
exp_folders["240208_LAr_X-ray_14mm_coll_693V_850V_46V"] = "X-ray_14mm_coll_693V";
exp_folders["240208_LAr_X-ray_14mm_coll_739V_850V_46V"] = "X-ray_14mm_coll_739V";
exp_folders["240208_LAr_X-ray_14mm_coll_785V_850V_46V"] = "X-ray_14mm_coll_785V";
exp_folders["240208_LAr_X-ray_14mm_coll_831V_850V_46V"] = "X-ray_14mm_coll_831V";
exp_folders["240208_LAr_X-ray_14mm_coll_877V_850V_46V"] = "X-ray_14mm_coll_877V";
...
//zcxv
if (exp == "240208_LAr_X-ray_Q_14mm_coll_8kV_850V_46V"
    || exp == "240208_LAr_X-ray_Q_14mm_coll_10kV_850V_46V"
    || exp == "240208_LAr_X-ray_Q_14mm_coll_12kV_850V_46V"
    || exp == "240208_LAr_X-ray_Q_14mm_coll_14kV_850V_46V"
    || exp == "240208_LAr_X-ray_Q_14mm_coll_16kV_850V_46V"
    || exp == "240208_LAr_X-ray_Q_14mm_coll_18kV_850V_46V"
    || exp == "240208_LAr_X-ray_Q_14mm_coll_20kV_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_0V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_139V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_185V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_231V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_277V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_323V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_369V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_416V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_462V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_508V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_554V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_600V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_646V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_693V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_739V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_785V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_831V_850V_46V"
    || exp == "240208_LAr_X-ray_14mm_coll_877V_850V_46V"
  ) {
...
set_corr(AStates::PMT_Npe_sum, AStates::MPPC_Npe_sum, -1, -1);
    ...
    if (exp == "240208_LAr_X-ray_Q_14mm_coll_8kV_850V_46V"
        ...
        x_y_regions = {0, 0, 120, 0, 120, 10, 0, 10};
    if (exp == "240208_LAr_X-ray_14mm_coll_323V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_369V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_416V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_462V_850V_46V"
        )
        x_y_regions = {0, 0, 90, 0, 90, 15, 0, 15};
    if (exp == "240208_LAr_X-ray_14mm_coll_508V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_554V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_600V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_646V_850V_46V")
        x_y_regions = {0, 0, 90, 0, 90, 18, 0, 18};
    if (exp == "240208_LAr_X-ray_14mm_coll_693V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_739V_850V_46V")
        x_y_regions = {0, 0, 80, 0, 80, 24, 0, 24};
    if (exp == "240208_LAr_X-ray_14mm_coll_785V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_831V_850V_46V")
        x_y_regions = {0, 0, 70, 0, 70, 12, 45, 24, 0, 24};
    if (exp == "240208_LAr_X-ray_14mm_coll_877V_850V_46V")
        x_y_regions = {0, 0, 80, 0, 80, 28, 0, 28};
    ...
    unset_log_z();
    // Show bubble-related photoelectrons
    bool extra = false;
    if (exp == "240208_LAr_X-ray_Q_14mm_coll_8kV_850V_46V"
        || exp == "240208_LAr_X-ray_Q_14mm_coll_10kV_850V_46V"
        || exp == "240208_LAr_X-ray_Q_14mm_coll_12kV_850V_46V"
        ...
        || exp == "240208_LAr_X-ray_Q_14mm_coll_18kV_850V_46V"
        || exp == "240208_LAr_X-ray_Q_14mm_coll_20kV_850V_46V") {
        set_zoom(1, 1000, 0.01, 100);
        set_bins(200, 100);
        extra = true;
    }
    if (exp == "240208_LAr_X-ray_Q_14mm_coll_16kV_850V_46V") {
        set_zoom(1, 3000, 0.01, 1000);
        set_bins(250, 200);
        extra = true;
    }
    if (exp == "240208_LAr_X-ray_14mm_coll_0V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_139V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_231V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_277V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_323V_850V_46V"
        ...
        || exp == "240208_LAr_X-ray_14mm_coll_693V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_739V_850V_46V") {
        set_zoom(1, 1000, 0.1, 100);
        set_bins(250, 100);
        extra = true;
    }
    if (exp == "240208_LAr_X-ray_14mm_coll_185V_850V_46V") {
        set_zoom(1, 3000, 0.1, 5000);
        set_bins(300, 500);
        extra = true;
    }
    if (exp == "240208_LAr_X-ray_14mm_coll_600V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_646V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_831V_850V_46V") {
        set_zoom(1, 4000, 0.1, 10000);
        set_bins(400, 400);
        extra = true;
    }
    if (exp == "240208_LAr_X-ray_14mm_coll_785V_850V_46V"
        || exp == "240208_LAr_X-ray_14mm_coll_877V_850V_46V") {
        set_zoom(1, 5000, 0.1, 20000);
        set_bins(500, 1000);
        extra = true;
    }
    if (extra) {
...
ty(AStates::PMT_Npe_sum);
    ...
    cut_x_y_poly(x_y_regions, true, "1");
    update();
    saveaspng(FOLDER + Num + "_SiPMs_vs_slowPMTs_Npe_"+cuts_str(cuts)+"_0");
    set_log_z();
    saveaspng(FOLDER + Num + "_SiPMs_vs_slowPMTs_Npe_"+cuts_str(cuts)+"_1_log");
    ...
    // Plot Npe for SiPMs and PMTs vs event number (time).
    set_corr(AStates::EventNumber, AStates::PMT_Npe_sum, -1, -1);
    ty(AStates::Correlation);
    remcut("1");
    set_zoom(0, post_processor->events_number(), 1, 4000);
    set_bins(post_processor->events_number()/100, 250);
    unset_hist_stats();
    set_log_y();
    set_log_bins_y();
    update();
    ...
    ty(AStates::Correlation);
    set_zoom(0, post_processor->events_number(), 0.1, 10000);
    set_bins(post_processor->events_number()/100, 250);
    unset_hist_stats();
    set_log_y();
    set_log_bins_y();
